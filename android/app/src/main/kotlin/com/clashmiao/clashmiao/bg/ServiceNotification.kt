package com.clashmiao.clashmiao.bg
...
import com.clashmiao.clashmiao.Settings
import com.clashmiao.clashmiao.constant.Action
import com.clashmiao.clashmiao.constant.Status
import com.clashmiao.clashmiao.utils.CommandClient
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "clashmiao service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
