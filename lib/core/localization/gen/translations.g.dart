...
///
/// Locales: 10
/// Strings: 3078 (307 per locale)
///
/// Built on 2026-05-15 at 04:33 UTC
...
class TranslationsProxiesEn {
	...
	String startDelayTestForGroups({required Object count}) => 'Started delay test for ${count} groups';
...
class TranslationsProxiesZhCn extends TranslationsProxiesEn {
	...
	@override String startDelayTestForGroups({required Object count}) => '已对 ${count} 个分组发起测速';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'home.routingMode.global': return 'Global';
			case 'home.routingMode.smart': return 'Smart';
			...
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'Started delay test for ${count} groups';
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'home.routingMode.global': return '全局';
			case 'home.routingMode.smart': return '智能';
			...
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => '已对 ${count} 个分组发起测速';
