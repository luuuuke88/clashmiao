...
///
/// Built on 2026-07-25 at 18:43 UTC
...
class TranslationsHomeEn {
	...
	String get emptyProfilesMsg => 'No lines yet';
	...
	String get coreMissingMsg => 'The app could not load its networking core. Connecting is unavailable. Reinstall the app, or make sure the core library file sits next to the executable.';
	String get degradedTitle => 'Connected, but no internet access';
	String get degradedMsg => 'The tunnel is up but traffic is not getting through. The node may be down — try another node, or disconnect.';
...
class TranslationsStatsEn {
	...
	String get liveSpeed => 'Live Speed';
...
class TranslationsProfileEn {
	...
	late final TranslationsProfileActionButtonsEn actionButtons = TranslationsProfileActionButtonsEn._(_root);
	late final TranslationsProfileAddEn add = TranslationsProfileAddEn._(_root);
	late final TranslationsProfileDetailsEn details = TranslationsProfileDetailsEn._(_root);
	late final TranslationsProfileShareEn share = TranslationsProfileShareEn._(_root);
	late final TranslationsProfileOverviewEn overview = TranslationsProfileOverviewEn._(_root);
	...
	String get remoteProfile => 'Remote Profile';
}
...
class TranslationsProxiesEn {
	...
	// Translations
	String get pageTitle => 'Lines';
	String get emptyProxiesMsg => 'No Lines Available';
	String get delayTestTooltip => 'Test Delay';
	String get sortTooltip => 'Sort Lines';
	String get checkIp => 'Check IP';
	String get unknownIp => 'Unknown IP';
	String get autoSelect => 'Auto Select';
	String get autoSelectDescription => 'Auto connect to the fastest node';
	late final TranslationsProxiesSortOptionsEn sortOptions = TranslationsProxiesSortOptionsEn._(_root);
	String get sortModalTitle => 'Choose sort method';
	String get activeProxySemanticLabel => 'Active Line';
	...
	String testingDelayInfo({required Object name}) => 'Testing delay for: ${name}';
	String switchedTo({required Object name}) => 'Switched to ${name}';
	String switchToFailed({required Object error}) => 'Failed to switch: ${error}';
	String get connectBeforeSwitch => 'Please connect before switching lines';
	String startDelayTestForGroups({required Object count}) => 'Started delay test for ${count} lines';
	String get delayTestBtn => 'Delay';
	String lineCount({required Object count}) => '${count} lines';
...
class TranslationsLogsEn {
	...
	String get logsUnderDevelopment => 'Log feature is under development';
	String get noLogsWhenDisconnected => 'Not connected, no logs';
}
...
class TranslationsSettingsEn {
	...
	String get systemProxyEnabled => 'System proxy enabled';
	String get systemProxyDisabled => 'System proxy disabled (Reconnect to apply)';
	String get adminPrivilegesRequired => 'Administrator privileges required on macOS';
	String get portChangeNotice => 'Port changes require reconnect to apply';
}
...
class TranslationsAboutEn {
	...
	String get appDescription => 'A cross-platform proxy client based on sing-box core';
}
...
class TranslationsConnectionEn {
	...
	String get staleSystemProxyCleaned => 'Cleaned up system proxy settings left behind by an abnormal exit last time';
}
...
class TranslationsConfigEn {
	...
	String get quickSettingsSubtitle => 'Customize your connection experience';
	String get setupWarp => 'Setup WARP';
	String get allOptions => 'All Config Options';
	String get allAdvancedOptions => 'All Advanced Options';
	...
	String get tproxyPort => 'Transparent Line Port';
	...
	String get setSystemProxy => 'Set System Line';
	...
	String get desktopProxyScopeNotice => 'On desktop, only apps that honor the system proxy are routed through the tunnel. Software that ignores it (some games, CLI tools, apps with their own proxy settings) connects directly and exposes your real IP.';
}
...
class TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeEn._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get global => 'Global Proxy';
	String get smart => 'Smart Routing';
}
...
class TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsEn._(this._root);
	...
	String get sort => 'Sort';
	String get copyConfigSuccess => 'Configuration copied';
...
class TranslationsProfileAddEn {
	...
	String get modalSubtitle => 'Choose how to add configuration file';
	...
	String get manuallyDescription => 'Manually enter server configuration';
	String get addWarp => 'Add Warp';
	String get warpDescription => 'Free acceleration with Cloudflare WARP';
...
class TranslationsProfileDetailsEn {
	TranslationsProfileDetailsEn._(this._root);
	...
	String get updateNowDescription => 'Fetch latest configuration from server';
	String get expireDate => 'Expire Date';
...
class TranslationsProfileShareEn {
	...
	String get subscriptionLinkCopied => 'Subscription link copied';
	String get configCopied => 'Configuration copied';
...
class TranslationsProfileOverviewEn {
	TranslationsProfileOverviewEn._(this._root);
...
class TranslationsProfileDetailsFormEn {
	...
	String get userAgentNotSet => 'Not Set';
	String get mux => 'Mux';
	String get muxDescription => 'Multiplex outbound connections to reduce handshake overhead';
}
...
class TranslationsSettingsGeneralEn {
	...
	late final TranslationsSettingsGeneralBatteryOptimizationStatusEn batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusEn._(_root);
}
...
class TranslationsSettingsNetworkEn {
	...
	// Translations
	String get perAppProxyPageTitle => 'Per-App Line Mode';
	...
	String get perAppProxyLoadFailedMsg => 'Failed to load app list';
	String get perAppProxyRetry => 'Retry';
	String get perAppProxyEmptyMsg => 'No results found';
	String get perAppProxyAndroidOnlyMsg => 'Per-app line mode is only supported on Android';
...
class TranslationsFailureSingboxEn {
	...
	String get startTimeout => 'Service Startup Timed Out';
}
...
class TranslationsConfigServiceModesEn {
	...
	// Translations
	String get proxy => 'Line Service Only';
	String get systemProxy => 'Set System Line';
	String get tun => 'VPN';
...
class TranslationsConfigShortServiceModesEn {
	...
	// Translations
	String get proxy => 'Line';
	String get systemProxy => 'System Line';
	String get tun => 'VPN';
	String get tunService => 'VPN Service';
}
...
class TranslationsConfigWarpDetourModesEn {
	...
	// Translations
	String get proxyOverWarp => 'Detour Lines Through WARP';
	String get warpOverProxy => 'Detour WARP Through Lines';
	String get inbound => 'Detour WARP Through Lines';
	String get outbound => 'Detour Lines Through WARP';
}
...
class TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusEn._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get exempted => 'Exempted';
	String get notExempted => 'Not Exempted';
	String get pending => '…';
}
...
class TranslationsSettingsNetworkPerAppProxyModesEn {
	...
	// Translations
	String get off => 'All';
	String get offMsg => 'Route All Apps Through Line';
	String get include => 'Route';
	String get includeMsg => 'Route Only Selected Apps Through Line';
	String get exclude => 'Bypass';
	String get excludeMsg => 'Do Not Route Selected Apps Through Line';
}
...
class TranslationsGeneralAr extends TranslationsGeneralEn {
	...
	// Translations
	@override String get appTitle => 'ClashMiao';
	...
	@override String get underDevelopment => 'قيد التطوير';
...
class TranslationsHomeAr extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeAr routingMode = TranslationsHomeRoutingModeAr._(_root);
	@override String failedToSwitchMode({required Object error}) => 'فشل تبديل الوضع: ${error}';
	@override String get connectionFailedTitle => 'فشل الاتصال';
	@override String get coreMissingTitle => 'لم يتم العثور على مكتبة النواة';
	@override String get coreMissingMsg => 'تعذّر على التطبيق تحميل نواة الشبكة. الاتصال غير متاح. أعد تثبيت التطبيق أو تأكد من وجود ملف مكتبة النواة بجوار الملف التنفيذي.';
	@override String get degradedTitle => 'متصل، لكن لا يوجد وصول إلى الإنترنت';
	@override String get degradedMsg => 'النفق يعمل لكن البيانات لا تمر. قد يكون الخادم معطلاً — جرّب خادماً آخر أو اقطع الاتصال.';
	@override String get degradedRetry => 'إعادة الفحص';
}
...
class TranslationsStatsAr extends TranslationsStatsEn {
	...
	@override String get trafficUsage => 'استخدام البيانات';
	@override String get liveSpeed => 'السرعة الحالية';
}
...
class TranslationsProfileAr extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsAr actionButtons = TranslationsProfileActionButtonsAr._(_root);
	@override late final TranslationsProfileDetailsAr details = TranslationsProfileDetailsAr._(_root);
	@override late final TranslationsProfileOverviewAr overview = TranslationsProfileOverviewAr._(_root);
	@override String get remoteProfile => 'اشتراك بعيد';
}
...
class TranslationsProxiesAr extends TranslationsProxiesEn {
	...
	@override String get autoSelectDescription => 'الاتصال تلقائياً بأسرع خادم';
	@override String get sortModalTitle => 'اختر طريقة الترتيب';
	@override String testingDelayInfo({required Object name}) => 'جارٍ اختبار التأخير لـ: ${name}';
	@override String switchedTo({required Object name}) => 'تم التبديل إلى ${name}';
	@override String switchToFailed({required Object error}) => 'فشل التبديل: ${error}';
	@override String get connectBeforeSwitch => 'يرجى الاتصال قبل تبديل الخطوط';
	@override String startDelayTestForGroups({required Object count}) => 'بدأ اختبار التأخير لـ ${count} خط';
	@override String get delayTestBtn => 'التأخير';
	@override String lineCount({required Object count}) => '${count} خط';
	@override String get manualSelect => 'اختيار يدوي';
	@override String get autoTest => 'اختبار تلقائي';
}
...
class TranslationsLogsAr extends TranslationsLogsEn {
	...
	@override String get logsCleared => 'تم مسح السجلات';
	@override String get logsCopied => 'تم نسخ السجلات';
	@override String get logsUnderDevelopment => 'ميزة السجلات قيد التطوير';
	@override String get noLogsWhenDisconnected => 'غير متصل، لا توجد سجلات';
}
...
class TranslationsSettingsAr extends TranslationsSettingsEn {
	...
	@override String get systemProxyEnabled => 'تم تفعيل بروكسي النظام';
	@override String get systemProxyDisabled => 'تم تعطيل بروكسي النظام (أعد الاتصال للتطبيق)';
	@override String get adminPrivilegesRequired => 'يتطلب صلاحيات المسؤول على macOS';
	@override String get portChangeNotice => 'تغييرات المنفذ تتطلب إعادة الاتصال لتفعيلها';
}
...
class TranslationsAboutAr extends TranslationsAboutEn {
	...
	@override String get appDescription => 'عميل بروكسي متعدد المنصات يعتمد على نواة sing-box';
}
...
class TranslationsConnectionAr extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => 'تم تنظيف إعدادات وكيل النظام المتبقية من إنهاء غير طبيعي سابق';
}
...
class TranslationsConfigAr extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => 'خصص تجربة الاتصال';
	@override String get allAdvancedOptions => 'جميع الخيارات المتقدمة';
	@override String get blockAds => 'حظر الإعلانات';
	@override String get warpNoiseSize => 'حجم الضجيج';
	@override String get warpNoiseMode => 'وضع الضجيج';
	@override String get desktopProxyScopeNotice => 'على سطح المكتب، يتم توجيه التطبيقات التي تحترم بروكسي النظام فقط عبر النفق. البرامج التي تتجاهله (بعض الألعاب وأدوات سطر الأوامر والتطبيقات ذات إعدادات البروكسي الخاصة) تتصل مباشرة وتكشف عنوان IP الحقيقي.';
}
...
class TranslationsHomeRoutingModeAr extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeAr._(TranslationsAr root) : this._root = root, super._(root);

	@override final TranslationsAr _root; // ignore: unused_field

	// Translations
	@override String get global => 'بروكسي عام';
	@override String get smart => 'توجيه ذكي';
}
...
class TranslationsProfileAddAr extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'اختر طريقة إضافة ملف الإعداد';
	@override String get manuallyDescription => 'أدخل إعداد الخادم يدوياً';
	@override String get addWarp => 'إضافة WARP';
	@override String get warpDescription => 'تسريع مجاني عبر Cloudflare WARP';
	@override String get addingWarpMsg => 'يرجى الانتظار أثناء تسجيل WARP.';
}
...
class TranslationsProfileShareAr extends TranslationsProfileShareEn {
	...
	@override String get subscriptionLinkCopied => 'تم نسخ رابط الاشتراك';
	@override String get configCopied => 'تم نسخ الإعداد';
	@override String get copyFailed => 'فشل النسخ';
}
...
class TranslationsProfileDetailsFormAr extends TranslationsProfileDetailsFormEn {
	...
	@override String get userAgentNotSet => 'Not Set';
	@override String get mux => 'Mux';
	@override String get muxDescription => 'Multiplex outbound connections to reduce handshake overhead';
}

// Path: profile.actionButtons
class TranslationsProfileActionButtonsAr extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsAr._(TranslationsAr root) : this._root = root, super._(root);

	@override final TranslationsAr _root; // ignore: unused_field

	// Translations
	@override String get add => 'إضافة';
	@override String get updateAll => 'تحديث الكل';
	@override String get sort => 'ترتيب';
	@override String get copyConfigSuccess => 'تم نسخ الإعداد';
	@override String get editConfig => 'تحرير الإعداد';
}

// Path: profile.details
class TranslationsProfileDetailsAr extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsAr._(TranslationsAr root) : this._root = root, super._(root);

	@override final TranslationsAr _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'معلومات أساسية';
	@override String get subscriptionStatus => 'حالة الاشتراك';
	@override String get options => 'خيارات';
	@override String get updateNow => 'تحديث الآن';
	@override String get updateNowDescription => 'جلب أحدث إعداد من الخادم';
...
class TranslationsProfileOverviewAr extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewAr._(TranslationsAr root) : this._root = root, super._(root);

	@override final TranslationsAr _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'قيد الاستخدام حالياً';
	@override String remainingDays({required Object days}) => 'متبقٍ ${days} يوماً';
}
...
class TranslationsSettingsGeneralAr extends TranslationsSettingsGeneralEn {
	...
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusAr batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusAr._(_root);
}
...
class TranslationsSettingsAdvancedAr extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'تمت إعادة تعيين ملف VPN';
}
...
class TranslationsSettingsNetworkAr extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'فشل تحميل قائمة التطبيقات';
	@override String get perAppProxyRetry => 'إعادة المحاولة';
	@override String get perAppProxyEmptyMsg => 'لا توجد نتائج';
	@override String get perAppProxyAndroidOnlyMsg => 'وضع الخط لكل تطبيق مدعوم على Android فقط';
}
...
class TranslationsFailureSingboxAr extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'مكتبة النواة غير مثبتة';
	@override String get startTimeout => 'انتهت مهلة بدء الخدمة';
}
...
class TranslationsFailureConnectivityAr extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'الشبكة غير متاحة';
}
...
class TranslationsFailureProfilesAr extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'لا يوجد اشتراك مفعّل';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusAr extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusAr._(TranslationsAr root) : this._root = root, super._(root);

	@override final TranslationsAr _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'مُستثنى';
	@override String get notExempted => 'غير مُستثنى';
...
class TranslationsGeneralEs extends TranslationsGeneralEn {
	...
	@override String get clipboardExportSuccessMsg => 'Copiado al portapapeles';
	@override String get openAppSettings => 'Abrir ajustes de la app';
	@override String get underDevelopment => 'En desarrollo';
...
class TranslationsHomeEs extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeEs routingMode = TranslationsHomeRoutingModeEs._(_root);
	@override String failedToSwitchMode({required Object error}) => 'Error al cambiar de modo: ${error}';
	@override String get connectionFailedTitle => 'Error de conexión';
	@override String get coreMissingTitle => 'No se encontró la biblioteca del núcleo';
	@override String get coreMissingMsg => 'La aplicación no pudo cargar su núcleo de red. La conexión no está disponible. Reinstala la aplicación o asegúrate de que el archivo de la biblioteca del núcleo esté junto al ejecutable.';
	@override String get degradedTitle => 'Conectado, pero sin acceso a Internet';
	@override String get degradedMsg => 'El túnel está activo pero el tráfico no pasa. Puede que el nodo esté caído: prueba otro nodo o desconéctate.';
	@override String get degradedRetry => 'Comprobar de nuevo';
}
...
class TranslationsProfileEs extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsEs actionButtons = TranslationsProfileActionButtonsEs._(_root);
	@override late final TranslationsProfileDetailsEs details = TranslationsProfileDetailsEs._(_root);
	@override late final TranslationsProfileOverviewEs overview = TranslationsProfileOverviewEs._(_root);
	@override String get remoteProfile => 'Perfil remoto';
}
...
class TranslationsProxiesEs extends TranslationsProxiesEn {
	...
	@override String get autoSelectDescription => 'Conectar automáticamente al nodo más rápido';
	@override String get sortModalTitle => 'Elige el método de ordenación';
	@override String get activeProxySemanticLabel => 'Línea activa';
	...
	@override String testingDelayInfo({required Object name}) => 'Probando latencia de: ${name}';
	@override String switchedTo({required Object name}) => 'Cambiado a ${name}';
	@override String switchToFailed({required Object error}) => 'Error al cambiar: ${error}';
	@override String get connectBeforeSwitch => 'Conéctate antes de cambiar de línea';
	@override String startDelayTestForGroups({required Object count}) => 'Prueba de latencia iniciada para ${count} líneas';
	@override String get delayTestBtn => 'Latencia';
	@override String lineCount({required Object count}) => '${count} líneas';
	@override String get manualSelect => 'Selección manual';
	@override String get autoTest => 'Prueba automática';
}
...
class TranslationsLogsEs extends TranslationsLogsEn {
	...
	@override String get logsCopied => 'Registros copiados';
	@override String get logsUnderDevelopment => 'La función de registros está en desarrollo';
	@override String get noLogsWhenDisconnected => 'Sin conexión, no hay registros';
}
...
class TranslationsSettingsEs extends TranslationsSettingsEn {
	...
	@override String get importOptionsMsg => 'Esto sobrescribirá todas las opciones de configuración con los valores proporcionados. ¿Continuar?';
	@override String get systemProxyEnabled => 'Proxy del sistema activado';
	@override String get systemProxyDisabled => 'Proxy del sistema desactivado (reconecta para aplicar)';
	@override String get adminPrivilegesRequired => 'Se requieren privilegios de administrador en macOS';
	@override String get portChangeNotice => 'Los cambios de puerto requieren reconectar para aplicarse';
}
...
class TranslationsAboutEs extends TranslationsAboutEn {
	...
	@override String get appDescription => 'Un cliente proxy multiplataforma basado en el núcleo sing-box';
}
...
class TranslationsPlayEs extends TranslationsPlayEn {
	...
	// Translations
	@override String get title => 'ClashMiao Next (vista previa)';
	@override String get short_description => 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
...
class TranslationsConnectionEs extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => 'Se limpiaron los ajustes de proxy del sistema que quedaron de una salida anómala';
}
...
class TranslationsConfigEs extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => 'Personaliza tu experiencia de conexión';
	@override String get setupWarp => 'Configurar WARP';
	@override String get allOptions => 'Todas las opciones de configuración';
	@override String get allAdvancedOptions => 'Todas las opciones avanzadas';
	...
	@override String get warpConfigGenerated => 'Configuración WARP generada';
	@override String get blockAds => 'Bloquear anuncios';
	@override String get tproxyPort => 'Puerto de línea transparente';
	@override String get warpNoiseSize => 'Tamaño del ruido';
	@override String get warpNoiseMode => 'Modo de ruido';
	@override String get warpNoiseDelay => 'Retardo de ruido';
	@override String get desktopProxyScopeNotice => 'En el escritorio, solo las aplicaciones que respetan el proxy del sistema pasan por el túnel. El software que lo ignora (algunos juegos, herramientas de línea de comandos, aplicaciones con su propia configuración de proxy) se conecta directamente y expone tu IP real.';
}
...
class TranslationsStatsEs extends TranslationsStatsEn {
	...
	@override String get trafficLive => 'Tráfico en vivo';
	@override String get trafficTotal => 'Tráfico total';
	@override String get trafficUsage => 'Uso de tráfico';
	@override String get liveSpeed => 'Velocidad en vivo';
...
class TranslationsHomeRoutingModeEs extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeEs._(TranslationsEs root) : this._root = root, super._(root);

	@override final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get global => 'Proxy global';
	@override String get smart => 'Enrutamiento inteligente';
}
...
class TranslationsProfileSubscriptionEs extends TranslationsProfileSubscriptionEn {
	...
	@override String get expireDate => 'Fecha de vencimiento';
}
...
class TranslationsProfileAddEs extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'Elige cómo añadir el archivo de configuración';
	@override String get manuallyDescription => 'Introduce la configuración del servidor manualmente';
	@override String get addWarp => 'Añadir WARP';
	@override String get warpDescription => 'Aceleración gratuita con Cloudflare WARP';
	@override String get addingWarpMsg => 'Espera mientras registramos WARP.';
}
...
class TranslationsProfileShareEs extends TranslationsProfileShareEn {
	...
	@override String get subscriptionLinkCopied => 'Enlace de suscripción copiado';
	@override String get configCopied => 'Configuración copiada';
	@override String get copyFailed => 'Error al copiar';
}
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsEs extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsEs._(TranslationsEs root) : this._root = root, super._(root);

	@override final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get add => 'Añadir';
	@override String get updateAll => 'Actualizar todo';
	@override String get sort => 'Ordenar';
	@override String get copyConfigSuccess => 'Configuración copiada';
...
class TranslationsProfileDetailsEs extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsEs._(TranslationsEs root) : this._root = root, super._(root);

	@override final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'Información básica';
	@override String get subscriptionStatus => 'Estado de la suscripción';
	@override String get options => 'Opciones';
	@override String get updateNow => 'Actualizar ahora';
	@override String get updateNowDescription => 'Obtener la configuración más reciente del servidor';
	@override String get expireDate => 'Fecha de vencimiento';
...
class TranslationsProfileOverviewEs extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewEs._(TranslationsEs root) : this._root = root, super._(root);

	@override final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'En uso';
	@override String remainingDays({required Object days}) => 'Quedan ${days} días';
}
...
class TranslationsSettingsGeneralEs extends TranslationsSettingsGeneralEn {
	...
	@override String get autoIpCheck => 'Comprobar automáticamente la IP de conexión';
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusEs batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusEs._(_root);
}
...
class TranslationsSettingsAdvancedEs extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'Perfil VPN restablecido';
}
...
class TranslationsSettingsNetworkEs extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'Error al cargar la lista de aplicaciones';
	@override String get perAppProxyRetry => 'Reintentar';
	@override String get perAppProxyEmptyMsg => 'No se encontraron resultados';
	@override String get perAppProxyAndroidOnlyMsg => 'El modo de línea por aplicación solo es compatible con Android';
}
...
class TranslationsFailureSingboxEs extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'Biblioteca del núcleo no instalada';
	@override String get startTimeout => 'Tiempo de inicio del servicio agotado';
}
...
class TranslationsFailureConnectivityEs extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'Red no disponible';
}
...
class TranslationsFailureProfilesEs extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'Sin perfil activo';
}
...
class TranslationsConfigWarpDetourModesEs extends TranslationsConfigWarpDetourModesEn {
	...
	@override String get proxyOverWarp => 'Desviar líneas a través de WARP';
	@override String get warpOverProxy => 'Desviar WARP a través de las líneas';
}
...
class TranslationsConfigShortServiceModesEs extends TranslationsConfigShortServiceModesEn {
	...
	// Translations
	@override String get proxy => 'Solo línea';
	@override String get systemProxy => 'Línea del sistema';
	@override String get tun => 'VPN';
	@override String get tunService => 'Servicio VPN';
}
...
class TranslationsProfileAddQrScannerEs extends TranslationsProfileAddQrScannerEn {
	...
	@override String get permissionRequest => 'Permiso de cámara para escanear el código QR';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusEs extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusEs._(TranslationsEs root) : this._root = root, super._(root);

	@override final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'Exento';
	@override String get notExempted => 'No exento';
	@override String get pending => '…';
}
...
class TranslationsGeneralFa extends TranslationsGeneralEn {
	...
	@override String get underDevelopment => 'در حال توسعه';
...
class TranslationsHomeFa extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeFa routingMode = TranslationsHomeRoutingModeFa._(_root);
	@override String failedToSwitchMode({required Object error}) => 'تغییر حالت ناموفق بود: ${error}';
	@override String get connectionFailedTitle => 'اتصال ناموفق';
	@override String get coreMissingTitle => 'کتابخانهٔ هسته پیدا نشد';
	@override String get coreMissingMsg => 'برنامه نتوانست هستهٔ شبکهٔ خود را بارگذاری کند. اتصال در دسترس نیست. برنامه را دوباره نصب کنید یا مطمئن شوید فایل کتابخانهٔ هسته کنار فایل اجرایی قرار دارد.';
	@override String get degradedTitle => 'متصل است، اما دسترسی به اینترنت وجود ندارد';
	@override String get degradedMsg => 'تونل برقرار است اما ترافیک عبور نمی‌کند. ممکن است نود از کار افتاده باشد — نود دیگری را امتحان کنید یا قطع کنید.';
	@override String get degradedRetry => 'بررسی مجدد';
}
...
class TranslationsStatsFa extends TranslationsStatsEn {
	...
	@override String get trafficUsage => 'مصرف ترافیک';
	@override String get liveSpeed => 'سرعت لحظه‌ای';
}
...
class TranslationsProfileFa extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsFa actionButtons = TranslationsProfileActionButtonsFa._(_root);
	@override late final TranslationsProfileDetailsFa details = TranslationsProfileDetailsFa._(_root);
	@override late final TranslationsProfileOverviewFa overview = TranslationsProfileOverviewFa._(_root);
	@override String get remoteProfile => 'پروفایل راه دور';
}
...
class TranslationsProxiesFa extends TranslationsProxiesEn {
	...
	@override String get autoSelectDescription => 'اتصال خودکار به سریع‌ترین نود';
	@override String get sortModalTitle => 'روش مرتب‌سازی را انتخاب کنید';
	@override String testingDelayInfo({required Object name}) => 'در حال آزمایش تأخیر: ${name}';
	@override String switchedTo({required Object name}) => 'به ${name} تغییر یافت';
	@override String switchToFailed({required Object error}) => 'تعویض ناموفق بود: ${error}';
	@override String get connectBeforeSwitch => 'پیش از تعویض خط، متصل شوید';
	@override String startDelayTestForGroups({required Object count}) => 'آزمایش تأخیر برای ${count} خط آغاز شد';
	@override String get delayTestBtn => 'تأخیر';
	@override String lineCount({required Object count}) => '${count} خط';
	@override String get manualSelect => 'انتخاب دستی';
	@override String get autoTest => 'تست خودکار';
}
...
class TranslationsLogsFa extends TranslationsLogsEn {
	...
	@override String get logsCleared => 'گزارش‌ها پاک شد';
	@override String get logsCopied => 'گزارش‌ها کپی شد';
	@override String get logsUnderDevelopment => 'قابلیت گزارش‌گیری در حال توسعه است';
	@override String get noLogsWhenDisconnected => 'متصل نیست، گزارشی وجود ندارد';
}
...
class TranslationsSettingsFa extends TranslationsSettingsEn {
	...
	@override String get systemProxyEnabled => 'پروکسی سیستم فعال شد';
	@override String get systemProxyDisabled => 'پروکسی سیستم غیرفعال شد (برای اعمال، دوباره وصل شوید)';
	@override String get adminPrivilegesRequired => 'در macOS به دسترسی مدیر نیاز است';
	@override String get portChangeNotice => 'تغییر پورت برای اعمال شدن نیاز به اتصال مجدد دارد';
}
...
class TranslationsAboutFa extends TranslationsAboutEn {
	...
	@override String get appDescription => 'یک کلاینت پروکسی چندسکویی مبتنی بر هستهٔ sing-box';
}
...
class TranslationsConnectionFa extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => 'تنظیمات پروکسی سیستم که از خروج غیرعادی قبلی باقی مانده بود پاک شد';
}
...
class TranslationsConfigFa extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => 'تجربهٔ اتصال خود را سفارشی کنید';
	@override String get allAdvancedOptions => 'همهٔ گزینه‌های پیشرفته';
	@override String get desktopProxyScopeNotice => 'در دسکتاپ، فقط برنامه‌هایی که پروکسی سیستم را رعایت می‌کنند از تونل عبور می‌کنند. نرم‌افزارهایی که آن را نادیده می‌گیرند (برخی بازی‌ها، ابزارهای خط فرمان، برنامه‌های دارای تنظیمات پروکسی مستقل) مستقیم وصل می‌شوند و IP واقعی شما را افشا می‌کنند.';
}
...
class TranslationsHomeRoutingModeFa extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeFa._(TranslationsFa root) : this._root = root, super._(root);

	@override final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get global => 'پروکسی سراسری';
	@override String get smart => 'مسیریابی هوشمند';
}
...
class TranslationsProfileAddFa extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'نحوهٔ افزودن فایل پیکربندی را انتخاب کنید';
	@override String get manuallyDescription => 'پیکربندی سرور را دستی وارد کنید';
	@override String get warpDescription => 'شتاب‌دهی رایگان با Cloudflare WARP';
}
...
class TranslationsProfileShareFa extends TranslationsProfileShareEn {
	...
	@override String get shareLink => 'اشتراک‌گذاری پیوند';
	@override String get subscriptionLinkCopied => 'پیوند اشتراک کپی شد';
	@override String get configCopied => 'پیکربندی کپی شد';
	@override String get copyFailed => 'کپی ناموفق بود';
}
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsFa extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsFa._(TranslationsFa root) : this._root = root, super._(root);

	@override final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get add => 'افزودن';
	@override String get updateAll => 'به‌روزرسانی همه';
	@override String get sort => 'مرتب‌سازی';
	@override String get copyConfigSuccess => 'پیکربندی کپی شد';
	@override String get editConfig => 'ویرایش پیکربندی';
}

// Path: profile.details
class TranslationsProfileDetailsFa extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsFa._(TranslationsFa root) : this._root = root, super._(root);

	@override final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'اطلاعات پایه';
	@override String get subscriptionStatus => 'وضعیت اشتراک';
	@override String get options => 'گزینه‌ها';
	@override String get updateNow => 'اکنون به‌روزرسانی کن';
	@override String get updateNowDescription => 'دریافت آخرین پیکربندی از سرور';
	@override String get expireDate => 'تاریخ انقضا';
	@override String get unlimited => 'نامحدود';
}

// Path: profile.overview
class TranslationsProfileOverviewFa extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewFa._(TranslationsFa root) : this._root = root, super._(root);

	@override final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'در حال استفاده';
	@override String remainingDays({required Object days}) => '${days} روز باقی مانده';
}
...
class TranslationsSettingsGeneralFa extends TranslationsSettingsGeneralEn {
	...
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusFa batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusFa._(_root);
}
...
class TranslationsSettingsAdvancedFa extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'پروفایل VPN بازنشانی شد';
}
...
class TranslationsSettingsNetworkFa extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'بارگذاری فهرست برنامه‌ها ناموفق بود';
	@override String get perAppProxyRetry => 'تلاش مجدد';
	@override String get perAppProxyEmptyMsg => 'نتیجه‌ای یافت نشد';
	@override String get perAppProxyAndroidOnlyMsg => 'حالت خط برای هر برنامه فقط در Android پشتیبانی می‌شود';
}
...
class TranslationsFailureSingboxFa extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'کتابخانهٔ هسته نصب نشده است';
	@override String get startTimeout => 'زمان راه‌اندازی سرویس به پایان رسید';
}
...
class TranslationsFailureConnectivityFa extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'شبکه در دسترس نیست';
}
...
class TranslationsFailureProfilesFa extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'هیچ پروفایل فعالی وجود ندارد';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusFa extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusFa._(TranslationsFa root) : this._root = root, super._(root);

	@override final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'مستثنی';
	@override String get notExempted => 'مستثنی نشده';
	@override String get pending => '…';
}
...
class TranslationsGeneralId extends TranslationsGeneralEn {
	...
	@override String get clipboardExportSuccessMsg => 'Disalin ke papan klip';
	...
	@override String get grantPermission => 'Berikan Izin';
	@override String get underDevelopment => 'Dalam Pengembangan';
...
class TranslationsHomeId extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeId routingMode = TranslationsHomeRoutingModeId._(_root);
	@override String failedToSwitchMode({required Object error}) => 'Gagal mengganti mode: ${error}';
	@override String get connectionFailedTitle => 'Koneksi Gagal';
	@override String get coreMissingTitle => 'Pustaka Inti Tidak Ditemukan';
	@override String get coreMissingMsg => 'Aplikasi tidak dapat memuat inti jaringannya. Koneksi tidak tersedia. Pasang ulang aplikasi, atau pastikan berkas pustaka inti berada di samping berkas eksekusi.';
	@override String get degradedTitle => 'Tersambung, tetapi tidak ada akses internet';
	@override String get degradedMsg => 'Terowongan aktif tetapi lalu lintas tidak tersalur. Node mungkin mati — coba node lain, atau putuskan koneksi.';
	@override String get degradedRetry => 'Periksa Lagi';
}
...
class TranslationsStatsId extends TranslationsStatsEn {
	...
	@override String get trafficUsage => 'Penggunaan Lalu Lintas';
	@override String get liveSpeed => 'Kecepatan Langsung';
...
class TranslationsProfileId extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsId actionButtons = TranslationsProfileActionButtonsId._(_root);
	@override late final TranslationsProfileDetailsId details = TranslationsProfileDetailsId._(_root);
	@override late final TranslationsProfileOverviewId overview = TranslationsProfileOverviewId._(_root);
	@override String get remoteProfile => 'Profil Jarak Jauh';
}
...
class TranslationsProxiesId extends TranslationsProxiesEn {
	...
	@override String get unknownIp => 'IP Tidak Diketahui';
	@override String get autoSelect => 'Pilih Otomatis';
	@override String get autoSelectDescription => 'Sambungkan otomatis ke node tercepat';
	@override String get sortModalTitle => 'Pilih metode pengurutan';
	@override String get activeProxySemanticLabel => 'Jalur Aktif';
	...
	@override String testingDelayInfo({required Object name}) => 'Menguji jeda untuk: ${name}';
	@override String switchedTo({required Object name}) => 'Beralih ke ${name}';
	@override String switchToFailed({required Object error}) => 'Gagal beralih: ${error}';
	@override String get connectBeforeSwitch => 'Sambungkan terlebih dahulu sebelum mengganti jalur';
	@override String startDelayTestForGroups({required Object count}) => 'Uji jeda dimulai untuk ${count} jalur';
	@override String get delayTestBtn => 'Jeda';
	@override String lineCount({required Object count}) => '${count} jalur';
	@override String get manualSelect => 'Pilih Manual';
	@override String get autoTest => 'Tes Otomatis';
}
...
class TranslationsLogsId extends TranslationsLogsEn {
	...
	@override String get logsCleared => 'Log dihapus';
	@override String get logsCopied => 'Log disalin';
	@override String get logsUnderDevelopment => 'Fitur log sedang dikembangkan';
	@override String get noLogsWhenDisconnected => 'Tidak tersambung, tidak ada log';
}
...
class TranslationsSettingsId extends TranslationsSettingsEn {
	...
	@override String get exportAllOptions => 'Salin Semua Opsi ke Papan Klip';
	@override String get importOptions => 'Impor Opsi dari Papan Klip';
	@override String get importOptionsMsg => 'Ini akan menimpa semua opsi konfigurasi dengan nilai yang diberikan. Anda yakin?';
	@override String get systemProxyEnabled => 'Proxy sistem diaktifkan';
	@override String get systemProxyDisabled => 'Proxy sistem dinonaktifkan (sambung ulang untuk menerapkan)';
	@override String get adminPrivilegesRequired => 'Memerlukan hak administrator di macOS';
	@override String get portChangeNotice => 'Perubahan port memerlukan sambung ulang agar berlaku';
}
...
class TranslationsAboutId extends TranslationsAboutEn {
	...
	@override String get appDescription => 'Klien proxy lintas platform berbasis inti sing-box';
}
...
class TranslationsConnectionId extends TranslationsConnectionEn {
	...
	@override String get reconnect => 'Sambungkan Ulang';
	@override String get connectAnyWay => 'Sambungkan';
	@override String get reconnectMsg => 'Menyambungkan ulang untuk menerapkan perubahan...';
	@override String get staleSystemProxyCleaned => 'Pengaturan proxy sistem yang tertinggal dari keluar tidak normal telah dibersihkan';
}
...
class TranslationsConfigId extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => 'Sesuaikan pengalaman koneksi Anda';
	@override String get setupWarp => 'Siapkan WARP';
	@override String get allOptions => 'Semua Opsi Konfigurasi';
	@override String get allAdvancedOptions => 'Semua Opsi Lanjutan';
	...
	@override String get generateWarpConfig => 'Buat Konfigurasi WARP';
	...
	@override String get tproxyPort => 'Port Jalur Transparan';
	@override String get warpNoiseSize => 'Ukuran Noise';
	@override String get warpNoiseMode => 'Mode Noise';
	@override String get warpNoiseDelay => 'Penundaan Noise';
	@override String get desktopProxyScopeNotice => 'Di desktop, hanya aplikasi yang mematuhi proxy sistem yang dialihkan melalui terowongan. Perangkat lunak yang mengabaikannya (beberapa game, alat baris perintah, aplikasi dengan pengaturan proxy sendiri) terhubung langsung dan membocorkan IP asli Anda.';
}
...
class TranslationsHomeRoutingModeId extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeId._(TranslationsId root) : this._root = root, super._(root);

	@override final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get global => 'Proxy Global';
	@override String get smart => 'Perutean Cerdas';
}
...
class TranslationsProfileAddId extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'Pilih cara menambahkan berkas konfigurasi';
	@override String get manuallyDescription => 'Masukkan konfigurasi server secara manual';
	@override String get addWarp => 'Tambah WARP';
	@override String get warpDescription => 'Akselerasi gratis dengan Cloudflare WARP';
	@override String get addingWarpMsg => 'Mohon tunggu, kami sedang mendaftarkan WARP.';
}
...
class TranslationsProfileShareId extends TranslationsProfileShareEn {
	...
	@override String get shareLink => 'Bagikan Tautan';
	@override String get subscriptionLinkCopied => 'Tautan langganan disalin';
	@override String get configCopied => 'Konfigurasi disalin';
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsId extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsId._(TranslationsId root) : this._root = root, super._(root);

	@override final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get add => 'Tambah';
	@override String get updateAll => 'Perbarui Semua';
	@override String get sort => 'Urutkan';
	@override String get copyConfigSuccess => 'Konfigurasi disalin';
	@override String get editConfig => 'Edit Konfigurasi';
}

// Path: profile.details
class TranslationsProfileDetailsId extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsId._(TranslationsId root) : this._root = root, super._(root);

	@override final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'Informasi Dasar';
	@override String get subscriptionStatus => 'Status Langganan';
	@override String get options => 'Opsi';
	@override String get updateNow => 'Perbarui Sekarang';
	@override String get updateNowDescription => 'Ambil konfigurasi terbaru dari server';
	@override String get expireDate => 'Tanggal Kedaluwarsa';
	@override String get unlimited => 'Tanpa Batas';
}

// Path: profile.overview
class TranslationsProfileOverviewId extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewId._(TranslationsId root) : this._root = root, super._(root);

	@override final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'Sedang Digunakan';
	@override String remainingDays({required Object days}) => 'Sisa ${days} hari';
}
...
class TranslationsProxiesDelaySemanticsId extends TranslationsProxiesDelaySemanticsEn {
	...
	// Translations
	@override String result({required Object delay}) => 'Jeda: ${delay}ms';
	@override String get timeout => 'Waktu Uji Jeda Habis';
	@override String get testing => 'Jeda: Menguji...';
}
...
class TranslationsSettingsGeneralId extends TranslationsSettingsGeneralEn {
	...
	@override String get autoIpCheck => 'Periksa IP Koneksi Otomatis';
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusId batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusId._(_root);
}
...
class TranslationsSettingsAdvancedId extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'Profil VPN telah direset';
}
...
class TranslationsSettingsNetworkId extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'Gagal memuat daftar aplikasi';
	@override String get perAppProxyRetry => 'Coba Lagi';
	@override String get perAppProxyEmptyMsg => 'Tidak ada hasil';
	@override String get perAppProxyAndroidOnlyMsg => 'Mode jalur per aplikasi hanya didukung di Android';
}
...
class TranslationsFailureSingboxId extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'Pustaka Inti Belum Terpasang';
	@override String get startTimeout => 'Waktu Mulai Layanan Habis';
}
...
class TranslationsFailureConnectivityId extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'Jaringan Tidak Tersedia';
}
...
class TranslationsFailureProfilesId extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'Tidak Ada Profil Aktif';
}
...
class TranslationsConfigWarpDetourModesId extends TranslationsConfigWarpDetourModesEn {
	...
	@override String get inbound => 'Detour WARP through proxies';
	@override String get outbound => 'Detour proxies through WARP';
	@override String get proxyOverWarp => 'Alihkan Jalur Melalui WARP';
	@override String get warpOverProxy => 'Alihkan WARP Melalui Jalur';
}
...
class TranslationsConfigShortServiceModesId extends TranslationsConfigShortServiceModesEn {
	...
	// Translations
	@override String get proxy => 'Hanya Jalur';
	@override String get systemProxy => 'Jalur Sistem';
	@override String get tun => 'VPN';
	@override String get tunService => 'Layanan VPN';
}
...
class TranslationsProfileAddQrScannerId extends TranslationsProfileAddQrScannerEn {
	...
	@override String get permissionRequest => 'Izin kamera untuk memindai Kode QR';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusId extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusId._(TranslationsId root) : this._root = root, super._(root);

	@override final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'Dikecualikan';
	@override String get notExempted => 'Tidak Dikecualikan';
	@override String get pending => '…';
}
...
class TranslationsGeneralPtBr extends TranslationsGeneralEn {
	...
	@override String get clipboardExportSuccessMsg => 'Copiado para a área de transferência';
	@override String get openAppSettings => 'Abrir configurações do app';
	@override String get underDevelopment => 'Em desenvolvimento';
	@override String get confirm => 'Confirmar';
}
...
class TranslationsHomePtBr extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModePtBr routingMode = TranslationsHomeRoutingModePtBr._(_root);
	@override String failedToSwitchMode({required Object error}) => 'Falha ao alternar o modo: ${error}';
	@override String get connectionFailedTitle => 'Falha na conexão';
	@override String get coreMissingTitle => 'Biblioteca do núcleo não encontrada';
	@override String get coreMissingMsg => 'O aplicativo não conseguiu carregar seu núcleo de rede. A conexão não está disponível. Reinstale o aplicativo ou verifique se o arquivo da biblioteca do núcleo está junto do executável.';
	@override String get degradedTitle => 'Conectado, mas sem acesso à internet';
	@override String get degradedMsg => 'O túnel está ativo, mas o tráfego não passa. O nó pode estar fora do ar — tente outro nó ou desconecte.';
	@override String get degradedRetry => 'Verificar novamente';
}
...
class TranslationsStatsPtBr extends TranslationsStatsEn {
	...
	@override String get trafficUsage => 'Uso de tráfego';
	@override String get liveSpeed => 'Velocidade ao vivo';
}
...
class TranslationsProfilePtBr extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsPtBr actionButtons = TranslationsProfileActionButtonsPtBr._(_root);
	@override late final TranslationsProfileDetailsPtBr details = TranslationsProfileDetailsPtBr._(_root);
	@override late final TranslationsProfileOverviewPtBr overview = TranslationsProfileOverviewPtBr._(_root);
	@override String get remoteProfile => 'Perfil remoto';
}
...
class TranslationsProxiesPtBr extends TranslationsProxiesEn {
	...
	@override String get autoSelectDescription => 'Conectar automaticamente ao nó mais rápido';
	@override String get sortModalTitle => 'Escolha o método de ordenação';
	@override String testingDelayInfo({required Object name}) => 'Testando latência de: ${name}';
	@override String switchedTo({required Object name}) => 'Alterado para ${name}';
	@override String switchToFailed({required Object error}) => 'Falha ao trocar: ${error}';
	@override String get connectBeforeSwitch => 'Conecte-se antes de trocar de linha';
	@override String startDelayTestForGroups({required Object count}) => 'Teste de latência iniciado para ${count} linhas';
	@override String get delayTestBtn => 'Latência';
	@override String lineCount({required Object count}) => '${count} linhas';
	@override String get manualSelect => 'Seleção manual';
	@override String get autoTest => 'Teste automático';
}
...
class TranslationsLogsPtBr extends TranslationsLogsEn {
	...
	@override String get logsCleared => 'Registros limpos';
	@override String get logsCopied => 'Registros copiados';
	@override String get logsUnderDevelopment => 'O recurso de registros está em desenvolvimento';
	@override String get noLogsWhenDisconnected => 'Desconectado, sem registros';
}
...
class TranslationsSettingsPtBr extends TranslationsSettingsEn {
	...
	@override String get importOptions => 'Importar opções da área de transferência';
	@override String get importOptionsMsg => 'Isso substituirá todas as opções de configuração pelos valores fornecidos. Tem certeza?';
	@override String get systemProxyEnabled => 'Proxy do sistema ativado';
	@override String get systemProxyDisabled => 'Proxy do sistema desativado (reconecte para aplicar)';
	@override String get adminPrivilegesRequired => 'Requer privilégios de administrador no macOS';
	@override String get portChangeNotice => 'Alterações de porta exigem reconexão para serem aplicadas';
}
...
class TranslationsAboutPtBr extends TranslationsAboutEn {
	...
	@override String get appDescription => 'Um cliente proxy multiplataforma baseado no núcleo sing-box';
}
...
class TranslationsPlayPtBr extends TranslationsPlayEn {
	...
	// Translations
	@override String get title => 'ClashMiao (Pré-visualização)';
	@override String get short_description => 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
}
...
class TranslationsConnectionPtBr extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => 'Configurações de proxy do sistema deixadas por um encerramento anormal foram limpas';
}
...
class TranslationsConfigPtBr extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => 'Personalize sua experiência de conexão';
	@override String get setupWarp => 'Configurar WARP';
	@override String get allOptions => 'Todas as opções de configuração';
	@override String get allAdvancedOptions => 'Todas as opções avançadas';
	...
	@override String get tproxyPort => 'Porta de linha transparente';
	@override String get warpNoiseSize => 'Tamanho do ruído';
	@override String get warpNoiseMode => 'Modo de ruído';
	@override String get desktopProxyScopeNotice => 'No desktop, apenas aplicativos que respeitam o proxy do sistema passam pelo túnel. Softwares que o ignoram (alguns jogos, ferramentas de linha de comando, apps com configuração de proxy própria) conectam diretamente e expõem seu IP real.';
}
...
class TranslationsHomeRoutingModePtBr extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModePtBr._(TranslationsPtBr root) : this._root = root, super._(root);

	@override final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get global => 'Proxy global';
	@override String get smart => 'Roteamento inteligente';
}
...
class TranslationsProfileAddPtBr extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'Escolha como adicionar o arquivo de configuração';
	@override String get manuallyDescription => 'Insira a configuração do servidor manualmente';
	@override String get addWarp => 'Adicionar WARP';
	@override String get warpDescription => 'Aceleração gratuita com Cloudflare WARP';
...
class TranslationsProfileSharePtBr extends TranslationsProfileShareEn {
	...
	@override String get subscriptionLinkCopied => 'Link de assinatura copiado';
	@override String get configCopied => 'Configuração copiada';
	@override String get copyFailed => 'Falha ao copiar';
}
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsPtBr extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsPtBr._(TranslationsPtBr root) : this._root = root, super._(root);

	@override final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get add => 'Adicionar';
	@override String get updateAll => 'Atualizar tudo';
	@override String get sort => 'Ordenar';
	@override String get copyConfigSuccess => 'Configuração copiada';
	@override String get editConfig => 'Editar configuração';
}

// Path: profile.details
class TranslationsProfileDetailsPtBr extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsPtBr._(TranslationsPtBr root) : this._root = root, super._(root);

	@override final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'Informações básicas';
	@override String get subscriptionStatus => 'Status da assinatura';
	@override String get options => 'Opções';
	@override String get updateNow => 'Atualizar agora';
	@override String get updateNowDescription => 'Buscar a configuração mais recente no servidor';
	@override String get expireDate => 'Data de expiração';
	@override String get unlimited => 'Ilimitado';
}

// Path: profile.overview
class TranslationsProfileOverviewPtBr extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewPtBr._(TranslationsPtBr root) : this._root = root, super._(root);

	@override final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'Em uso';
	@override String remainingDays({required Object days}) => 'Restam ${days} dias';
}
...
class TranslationsSettingsGeneralPtBr extends TranslationsSettingsGeneralEn {
	...
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusPtBr batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusPtBr._(_root);
}
...
class TranslationsSettingsAdvancedPtBr extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'Perfil de VPN redefinido';
}
...
class TranslationsSettingsNetworkPtBr extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'Falha ao carregar a lista de aplicativos';
	@override String get perAppProxyRetry => 'Tentar novamente';
	@override String get perAppProxyEmptyMsg => 'Nenhum resultado encontrado';
	@override String get perAppProxyAndroidOnlyMsg => 'O modo de linha por aplicativo é compatível apenas com Android';
}
...
class TranslationsFailureSingboxPtBr extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'Biblioteca do núcleo não instalada';
	@override String get startTimeout => 'Tempo de inicialização do serviço esgotado';
}
...
class TranslationsFailureConnectivityPtBr extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'Rede indisponível';
}
...
class TranslationsFailureProfilesPtBr extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'Nenhum perfil ativo';
}
...
class TranslationsConfigWarpDetourModesPtBr extends TranslationsConfigWarpDetourModesEn {
	...
	@override String get proxyOverWarp => 'Desviar linhas através do WARP';
	@override String get warpOverProxy => 'Desviar WARP através das linhas';
}
...
class TranslationsConfigShortServiceModesPtBr extends TranslationsConfigShortServiceModesEn {
	...
	// Translations
	@override String get proxy => 'Somente linha';
	@override String get systemProxy => 'Linha do sistema';
	@override String get tun => 'VPN';
	@override String get tunService => 'Serviço VPN';
}
...
class TranslationsProfileAddQrScannerPtBr extends TranslationsProfileAddQrScannerEn {
	...
	@override String get permissionRequest => 'Permissão de câmera para ler o código QR';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusPtBr extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusPtBr._(TranslationsPtBr root) : this._root = root, super._(root);

	@override final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'Isento';
	@override String get notExempted => 'Não isento';
	@override String get pending => '…';
}
...
class TranslationsGeneralRu extends TranslationsGeneralEn {
	...
	@override String get underDevelopment => 'В разработке';
...
class TranslationsHomeRu extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeRu routingMode = TranslationsHomeRoutingModeRu._(_root);
	@override String failedToSwitchMode({required Object error}) => 'Не удалось сменить режим: ${error}';
	@override String get connectionFailedTitle => 'Не удалось подключиться';
	@override String get coreMissingTitle => 'Библиотека ядра не найдена';
	@override String get coreMissingMsg => 'Приложению не удалось загрузить сетевое ядро. Подключение недоступно. Переустановите приложение или убедитесь, что файл библиотеки ядра находится рядом с исполняемым файлом.';
	@override String get degradedTitle => 'Подключено, но нет доступа в интернет';
	@override String get degradedMsg => 'Туннель поднят, но трафик не проходит. Возможно, узел недоступен — попробуйте другой узел или отключитесь.';
	@override String get degradedRetry => 'Проверить ещё раз';
}
...
class TranslationsStatsRu extends TranslationsStatsEn {
	...
	@override String get trafficUsage => 'Использование трафика';
	@override String get liveSpeed => 'Текущая скорость';
}
...
class TranslationsProfileRu extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsRu actionButtons = TranslationsProfileActionButtonsRu._(_root);
	@override late final TranslationsProfileDetailsRu details = TranslationsProfileDetailsRu._(_root);
	@override late final TranslationsProfileOverviewRu overview = TranslationsProfileOverviewRu._(_root);
	@override String get remoteProfile => 'Удалённый профиль';
}
...
class TranslationsProxiesRu extends TranslationsProxiesEn {
	...
	@override String get autoSelectDescription => 'Автоматически подключаться к самому быстрому узлу';
	@override String get sortModalTitle => 'Выберите способ сортировки';
	@override String testingDelayInfo({required Object name}) => 'Проверка задержки: ${name}';
	@override String switchedTo({required Object name}) => 'Переключено на ${name}';
	@override String switchToFailed({required Object error}) => 'Не удалось переключить: ${error}';
	@override String get connectBeforeSwitch => 'Подключитесь перед сменой линии';
	@override String startDelayTestForGroups({required Object count}) => 'Запущена проверка задержки для ${count} линий';
	@override String get delayTestBtn => 'Задержка';
	@override String lineCount({required Object count}) => 'Линий: ${count}';
	@override String get manualSelect => 'Ручной выбор';
	@override String get autoTest => 'Автотест';
}
...
class TranslationsLogsRu extends TranslationsLogsEn {
	...
	@override String get logsCleared => 'Журналы очищены';
	@override String get logsCopied => 'Журналы скопированы';
	@override String get logsUnderDevelopment => 'Функция журналов в разработке';
	@override String get noLogsWhenDisconnected => 'Нет подключения, журналы отсутствуют';
}
...
class TranslationsSettingsRu extends TranslationsSettingsEn {
	...
	@override String get exportAllOptions => 'Копировать все параметры в буфер обмена';
	@override String get systemProxyEnabled => 'Системный прокси включён';
	@override String get systemProxyDisabled => 'Системный прокси отключён (переподключитесь для применения)';
	@override String get adminPrivilegesRequired => 'На macOS требуются права администратора';
	@override String get portChangeNotice => 'Изменения порта применяются после переподключения';
}
...
class TranslationsAboutRu extends TranslationsAboutEn {
	...
	@override String get appDescription => 'Кроссплатформенный прокси-клиент на основе ядра sing-box';
}
...
class TranslationsConnectionRu extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => 'Удалены настройки системного прокси, оставшиеся после аварийного завершения';
}
...
class TranslationsConfigRu extends TranslationsConfigEn {
	...
	@override String get warpPort => 'Port';
	@override String get warpNoise => 'Noise';
	@override String get quickSettingsSubtitle => 'Настройте подключение под себя';
	@override String get allAdvancedOptions => 'Все дополнительные настройки';
	@override String get blockAds => 'Блокировать рекламу';
	@override String get warpNoiseSize => 'Размер шума';
	@override String get warpNoiseMode => 'Режим шума';
	@override String get warpNoiseDelay => 'Задержка шума';
	@override String get desktopProxyScopeNotice => 'На настольных системах через туннель идут только приложения, соблюдающие системный прокси. Программы, которые его игнорируют (некоторые игры, консольные утилиты, приложения с собственными настройками прокси), подключаются напрямую и раскрывают ваш реальный IP.';
}
...
class TranslationsHomeRoutingModeRu extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeRu._(TranslationsRu root) : this._root = root, super._(root);

	@override final TranslationsRu _root; // ignore: unused_field

	// Translations
	@override String get global => 'Глобальный прокси';
	@override String get smart => 'Умная маршрутизация';
}
...
class TranslationsProfileAddRu extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'Выберите способ добавления файла конфигурации';
	@override String get manuallyDescription => 'Введите конфигурацию сервера вручную';
	@override String get addWarp => 'Добавить WARP';
	@override String get warpDescription => 'Бесплатное ускорение через Cloudflare WARP';
	@override String get addingWarpMsg => 'Подождите, идёт регистрация WARP.';
}
...
class TranslationsProfileShareRu extends TranslationsProfileShareEn {
	...
	@override String get subscriptionLinkCopied => 'Ссылка на подписку скопирована';
	@override String get configCopied => 'Конфигурация скопирована';
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsRu extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsRu._(TranslationsRu root) : this._root = root, super._(root);

	@override final TranslationsRu _root; // ignore: unused_field

	// Translations
	@override String get add => 'Добавить';
	@override String get updateAll => 'Обновить все';
	@override String get sort => 'Сортировать';
	@override String get copyConfigSuccess => 'Конфигурация скопирована';
	@override String get editConfig => 'Изменить конфигурацию';
}

// Path: profile.details
class TranslationsProfileDetailsRu extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsRu._(TranslationsRu root) : this._root = root, super._(root);

	@override final TranslationsRu _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'Основные сведения';
	@override String get subscriptionStatus => 'Состояние подписки';
	@override String get options => 'Параметры';
	@override String get updateNow => 'Обновить сейчас';
	@override String get updateNowDescription => 'Загрузить актуальную конфигурацию с сервера';
	@override String get expireDate => 'Дата окончания';
	@override String get unlimited => 'Безлимитно';
}

// Path: profile.overview
class TranslationsProfileOverviewRu extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewRu._(TranslationsRu root) : this._root = root, super._(root);

	@override final TranslationsRu _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'Используется сейчас';
	@override String remainingDays({required Object days}) => 'Осталось ${days} дн.';
}
...
class TranslationsSettingsGeneralRu extends TranslationsSettingsGeneralEn {
	...
	@override String get hapticFeedback => 'Тактильная отдача';
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusRu batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusRu._(_root);
}
...
class TranslationsSettingsAdvancedRu extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'Профиль VPN сброшен';
}
...
class TranslationsSettingsNetworkRu extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'Не удалось загрузить список приложений';
	@override String get perAppProxyRetry => 'Повторить';
	@override String get perAppProxyEmptyMsg => 'Ничего не найдено';
	@override String get perAppProxyAndroidOnlyMsg => 'Режим линий для отдельных приложений поддерживается только на Android';
}
...
class TranslationsFailureSingboxRu extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'Библиотека ядра не установлена';
	@override String get startTimeout => 'Истекло время запуска службы';
}
...
class TranslationsFailureConnectivityRu extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'Сеть недоступна';
}
...
class TranslationsFailureProfilesRu extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'Нет активного профиля';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusRu extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusRu._(TranslationsRu root) : this._root = root, super._(root);

	@override final TranslationsRu _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'Исключено';
	@override String get notExempted => 'Не исключено';
	@override String get pending => '…';
}
...
class TranslationsGeneralTr extends TranslationsGeneralEn {
	...
	@override String get clipboardExportSuccessMsg => 'Panoya kopyalandı';
	@override String get openAppSettings => 'Uygulama Ayarlarını Aç';
	@override String get underDevelopment => 'Geliştirme Aşamasında';
...
class TranslationsHomeTr extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeTr routingMode = TranslationsHomeRoutingModeTr._(_root);
	@override String failedToSwitchMode({required Object error}) => 'Mod değiştirilemedi: ${error}';
	@override String get connectionFailedTitle => 'Bağlantı Başarısız';
	@override String get coreMissingTitle => 'Çekirdek Kitaplığı Bulunamadı';
	@override String get coreMissingMsg => 'Uygulama ağ çekirdeğini yükleyemedi. Bağlantı kullanılamıyor. Uygulamayı yeniden kurun ya da çekirdek kitaplık dosyasının çalıştırılabilir dosyanın yanında olduğundan emin olun.';
	@override String get degradedTitle => 'Bağlandı, ancak internet erişimi yok';
	@override String get degradedMsg => 'Tünel açık ancak trafik geçmiyor. Sunucu çalışmıyor olabilir — başka bir sunucu deneyin veya bağlantıyı kesin.';
	@override String get degradedRetry => 'Yeniden Denetle';
}
...
class TranslationsStatsTr extends TranslationsStatsEn {
	...
	@override String get traffic => 'Trafik';
	@override String get trafficUsage => 'Trafik Kullanımı';
	@override String get liveSpeed => 'Anlık Hız';
...
class TranslationsProfileTr extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsTr actionButtons = TranslationsProfileActionButtonsTr._(_root);
	@override late final TranslationsProfileDetailsTr details = TranslationsProfileDetailsTr._(_root);
	@override late final TranslationsProfileOverviewTr overview = TranslationsProfileOverviewTr._(_root);
	@override String get remoteProfile => 'Uzak Profil';
}
...
class TranslationsProxiesTr extends TranslationsProxiesEn {
	...
	@override String get checkIp => 'IP\'yi Denetle';
	@override String get unknownIp => 'Bilinmeyen IP';
	@override String get autoSelect => 'Otomatik Seçim';
	@override String get autoSelectDescription => 'En hızlı sunucuya otomatik bağlan';
	@override String get sortModalTitle => 'Sıralama yöntemini seçin';
	@override String get activeProxySemanticLabel => 'Etkin Hat';
	...
	@override String testingDelayInfo({required Object name}) => 'Gecikme test ediliyor: ${name}';
	@override String switchedTo({required Object name}) => '${name} olarak değiştirildi';
	@override String switchToFailed({required Object error}) => 'Geçiş başarısız: ${error}';
	@override String get connectBeforeSwitch => 'Hat değiştirmeden önce bağlanın';
	@override String startDelayTestForGroups({required Object count}) => '${count} hat için gecikme testi başlatıldı';
	@override String get delayTestBtn => 'Gecikme';
	@override String lineCount({required Object count}) => '${count} hat';
	@override String get manualSelect => 'Elle Seçim';
	@override String get autoTest => 'Otomatik Test';
}
...
class TranslationsLogsTr extends TranslationsLogsEn {
	...
	@override String get logsCopied => 'Günlükler kopyalandı';
	@override String get logsUnderDevelopment => 'Günlük özelliği geliştirme aşamasında';
	@override String get noLogsWhenDisconnected => 'Bağlı değil, günlük yok';
}
...
class TranslationsSettingsTr extends TranslationsSettingsEn {
	...
	@override String get importOptions => 'Seçenekleri Panodan İçe Aktar';
	@override String get importOptionsMsg => 'Bu işlem tüm yapılandırma seçeneklerini verilen değerlerle değiştirir. Emin misiniz?';
	@override String get systemProxyEnabled => 'Sistem proxy’si etkin';
	@override String get systemProxyDisabled => 'Sistem proxy’si devre dışı (uygulamak için yeniden bağlanın)';
	@override String get adminPrivilegesRequired => 'macOS\'ta yönetici ayrıcalıkları gerekir';
	@override String get portChangeNotice => 'Bağlantı noktası değişikliklerinin uygulanması için yeniden bağlanmak gerekir';
}
...
class TranslationsAboutTr extends TranslationsAboutEn {
	...
	@override String get appDescription => 'sing-box çekirdeğine dayalı çok platformlu proxy istemcisi';
}
...
class TranslationsPlayTr extends TranslationsPlayEn {
	...
	// Translations
	@override String get title => 'ClashMiao (Önizleme)';
	@override String get short_description => 'Otomatik, SSH, VLESS, Vmess, Trojan, Reality, Sing-Box, Clash, Xray, Shadowsocks';
...
class TranslationsConnectionTr extends TranslationsConnectionEn {
	...
	@override String get connectAnyWay => 'Bağlan';
	@override String get reconnectMsg => 'Değişiklikleri uygulamak için yeniden bağlanılıyor...';
	@override String get staleSystemProxyCleaned => 'Önceki anormal çıkıştan kalan sistem proxy ayarları temizlendi';
}
...
class TranslationsConfigTr extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => 'Bağlantı deneyiminizi özelleştirin';
	@override String get setupWarp => 'WARP Kurulumu';
	@override String get allOptions => 'Tüm Yapılandırma Seçenekleri';
	@override String get allAdvancedOptions => 'Tüm Gelişmiş Seçenekler';
	...
	@override String get tproxyPort => 'Şeffaf Hat Bağlantı Noktası';
	...
	@override String get desktopProxyScopeNotice => 'Masaüstünde yalnızca sistem proxy ayarına uyan uygulamalar tünelden geçer. Buna uymayan yazılımlar (bazı oyunlar, komut satırı araçları, kendi proxy ayarı olan uygulamalar) doğrudan bağlanır ve gerçek IP adresinizi açığa çıkarır.';
}
...
class TranslationsHomeRoutingModeTr extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeTr._(TranslationsTr root) : this._root = root, super._(root);

	@override final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get global => 'Genel Proxy';
	@override String get smart => 'Akıllı Yönlendirme';
}
...
class TranslationsProfileAddTr extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => 'Yapılandırma dosyasını nasıl ekleyeceğinizi seçin';
	@override String get manuallyDescription => 'Sunucu yapılandırmasını elle girin';
	@override String get addWarp => 'WARP Ekle';
	@override String get warpDescription => 'Cloudflare WARP ile ücretsiz hızlandırma';
	@override String get addingWarpMsg => 'WARP kaydedilirken lütfen bekleyin.';
}
...
class TranslationsProfileShareTr extends TranslationsProfileShareEn {
	...
	@override String get subscriptionLinkCopied => 'Abonelik bağlantısı kopyalandı';
	@override String get configCopied => 'Yapılandırma kopyalandı';
	@override String get copyFailed => 'Kopyalama başarısız';
}
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsTr extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsTr._(TranslationsTr root) : this._root = root, super._(root);

	@override final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get add => 'Ekle';
	@override String get updateAll => 'Tümünü Güncelle';
	@override String get sort => 'Sırala';
	@override String get copyConfigSuccess => 'Yapılandırma kopyalandı';
	@override String get editConfig => 'Yapılandırmayı Düzenle';
}

// Path: profile.details
class TranslationsProfileDetailsTr extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsTr._(TranslationsTr root) : this._root = root, super._(root);

	@override final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => 'Temel Bilgiler';
	@override String get subscriptionStatus => 'Abonelik Durumu';
	@override String get options => 'Seçenekler';
	@override String get updateNow => 'Şimdi Güncelle';
	@override String get updateNowDescription => 'Sunucudan en güncel yapılandırmayı al';
	@override String get expireDate => 'Son Kullanma Tarihi';
...
class TranslationsProfileOverviewTr extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewTr._(TranslationsTr root) : this._root = root, super._(root);

	@override final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => 'Şu Anda Kullanılıyor';
	@override String remainingDays({required Object days}) => '${days} gün kaldı';
}
...
class TranslationsSettingsGeneralTr extends TranslationsSettingsGeneralEn {
	...
	@override String get autoIpCheck => 'Bağlantı IP’sini Otomatik Denetle';
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusTr batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusTr._(_root);
}
...
class TranslationsSettingsAdvancedTr extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'VPN profili sıfırlandı';
}
...
class TranslationsSettingsNetworkTr extends TranslationsSettingsNetworkEn {
	...
	@override String get perAppProxyLoadFailedMsg => 'Uygulama listesi yüklenemedi';
	@override String get perAppProxyRetry => 'Yeniden Dene';
	@override String get perAppProxyEmptyMsg => 'Sonuç bulunamadı';
	@override String get perAppProxyAndroidOnlyMsg => 'Uygulama başına hat modu yalnızca Android’de desteklenir';
}
...
class TranslationsFailureSingboxTr extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => 'Çekirdek Kitaplığı Yüklü Değil';
	@override String get startTimeout => 'Servis Başlatma Zaman Aşımı';
}
...
class TranslationsFailureConnectivityTr extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => 'Ağ Kullanılamıyor';
}
...
class TranslationsFailureProfilesTr extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => 'Etkin Profil Yok';
}
...
class TranslationsConfigWarpDetourModesTr extends TranslationsConfigWarpDetourModesEn {
	...
	@override String get inbound => 'Detour WARP through proxies';
	@override String get outbound => 'Detour proxies through WARP';
	@override String get proxyOverWarp => 'Hatları WARP Üzerinden Geçir';
	@override String get warpOverProxy => 'WARP\'ı Hatlar Üzerinden Geçir';
}
...
class TranslationsConfigShortServiceModesTr extends TranslationsConfigShortServiceModesEn {
	...
	// Translations
	@override String get proxy => 'Yalnızca Hat';
	@override String get systemProxy => 'Sistem Hattı';
	@override String get tun => 'VPN';
	@override String get tunService => 'VPN Servisi';
}
...
class TranslationsProfileAddQrScannerTr extends TranslationsProfileAddQrScannerEn {
	...
	@override String get permissionRequest => 'QR Kodu taramak için kamera izni';
}
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusTr extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusTr._(TranslationsTr root) : this._root = root, super._(root);

	@override final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get exempted => 'Muaf';
	@override String get notExempted => 'Muaf Değil';
	@override String get pending => '…';
}
...
class TranslationsGeneralZhCn extends TranslationsGeneralEn {
	...
	// Translations
	@override String get appTitle => 'Clash喵喵';
	...
	@override String get underDevelopment => '功能开发中';
...
class TranslationsHomeZhCn extends TranslationsHomeEn {
	...
	@override String get emptyProfilesMsg => '还没有线路喵';
	...
	@override String get coreMissingTitle => '未找到核心库';
	@override String get coreMissingMsg => '应用没能加载网络核心库，无法建立连接。请重新安装应用，或确认核心库文件与主程序在同一目录下。';
	@override String get degradedTitle => '已连接，但无法访问网络';
	@override String get degradedMsg => '隧道已建立，但数据送不出去。可能是节点已失效——试试换一个节点，或者断开连接。';
	@override String get degradedRetry => '重新检测';
}
...
class TranslationsStatsZhCn extends TranslationsStatsEn {
	...
	@override String get trafficUsage => '流量使用';
	@override String get liveSpeed => '实时速度';
...
class TranslationsProfileZhCn extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsZhCn actionButtons = TranslationsProfileActionButtonsZhCn._(_root);
	@override late final TranslationsProfileAddZhCn add = TranslationsProfileAddZhCn._(_root);
	@override late final TranslationsProfileDetailsZhCn details = TranslationsProfileDetailsZhCn._(_root);
	@override late final TranslationsProfileShareZhCn share = TranslationsProfileShareZhCn._(_root);
	@override late final TranslationsProfileOverviewZhCn overview = TranslationsProfileOverviewZhCn._(_root);
	...
	@override String get remoteProfile => '远程订阅';
}
...
class TranslationsProxiesZhCn extends TranslationsProxiesEn {
	...
	@override String testingDelayInfo({required Object name}) => '正在测速: ${name}';
	@override String switchedTo({required Object name}) => '已切换到 ${name}';
	@override String switchToFailed({required Object error}) => '切换失败: ${error}';
	@override String get connectBeforeSwitch => '请先连接后再切换节点';
	@override String startDelayTestForGroups({required Object count}) => '已开始测试当前订阅的 ${count} 个节点';
	@override String get delayTestBtn => '测速';
	@override String lineCount({required Object count}) => '${count} 个节点';
	@override String get manualSelect => '手动选择';
	@override String get autoTest => '自动测速';
}
...
class TranslationsLogsZhCn extends TranslationsLogsEn {
	...
	@override String get logsCleared => '日志已清空';
	@override String get logsCopied => '日志已复制';
	@override String get logsUnderDevelopment => '日志功能开发中';
	@override String get noLogsWhenDisconnected => '未连接，无日志';
}
...
class TranslationsSettingsZhCn extends TranslationsSettingsEn {
	...
	@override String get systemProxyEnabled => '已开启系统代理';
	@override String get systemProxyDisabled => '已关闭系统代理（需重连生效）';
	@override String get adminPrivilegesRequired => 'macOS 需要管理员权限';
	@override String get portChangeNotice => '端口修改需要重启连接生效';
}
...
class TranslationsAboutZhCn extends TranslationsAboutEn {
	...
	@override String get appDescription => '基于 sing-box 核心的跨平台代理客户端';
}
...
class TranslationsTrayZhCn extends TranslationsTrayEn {
	...
	@override String get hide => '隐藏到托盘';
...
class TranslationsConnectionZhCn extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => '已清理上次异常退出残留的系统代理设置';
}
...
class TranslationsConfigZhCn extends TranslationsConfigEn {
	...
	@override String get quickSettingsSubtitle => '自定义您的连接体验';
	@override String get setupWarp => '配置 WARP';
	@override String get allOptions => '全部配置选项';
	@override String get allAdvancedOptions => '所有进阶选项';
	...
	@override String get tproxyPort => '透明线路端口';
	...
	@override String get setSystemProxy => '设置系统线路';
	...
	@override String get warpDetourMode => '链式线路';
	...
	@override String get warpNoiseDelay => '噪音延延迟';
	@override String get desktopProxyScopeNotice => '桌面端只有遵循系统代理设置的程序会走隧道。不遵循的软件（部分游戏、命令行工具、自带代理设置的客户端）会直连，暴露你的真实 IP。';
...
// Path: home.routingMode
class TranslationsHomeRoutingModeZhCn extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeZhCn._(TranslationsZhCn root) : this._root = root, super._(root);

	@override final TranslationsZhCn _root; // ignore: unused_field

	// Translations
	@override String get global => '全局代理';
	@override String get smart => '智能分流';
}
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsZhCn extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsZhCn._(TranslationsZhCn root) : this._root = root, super._(root);
	...
	@override String get sort => '排序';
	@override String get copyConfigSuccess => '配置内容已复制';
...
class TranslationsProfileAddZhCn extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => '选择添加配置文件的方式';
	...
	@override String get manuallyDescription => '手动输入服务器配置信息';
	@override String get addWarp => '添加 WARP';
	@override String get warpDescription => '使用 Cloudflare WARP 免费加速';
...
// Path: profile.details
class TranslationsProfileDetailsZhCn extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsZhCn._(TranslationsZhCn root) : this._root = root, super._(root);

	@override final TranslationsZhCn _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => '基础信息';
	@override String get subscriptionStatus => '订阅状态';
	@override String get options => '选项';
	@override String get updateNow => '立即更新';
	@override String get updateNowDescription => '从服务器获取最新配置';
	@override String get expireDate => '到期时间';
	@override String get unlimited => '无限期';
}
...
class TranslationsProfileShareZhCn extends TranslationsProfileShareEn {
	...
	@override String get subscriptionLinkCopied => '订阅链接已复制';
	@override String get configCopied => '配置内容已复制';
...
// Path: profile.overview
class TranslationsProfileOverviewZhCn extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewZhCn._(TranslationsZhCn root) : this._root = root, super._(root);

	@override final TranslationsZhCn _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => '当前使用';
	@override String remainingDays({required Object days}) => '剩余 ${days} 天';
}
...
class TranslationsProfileDetailsFormZhCn extends TranslationsProfileDetailsFormEn {
	...
	@override String get userAgent => 'User-Agent';
	@override String get userAgentNotSet => '未设置';
	@override String get mux => 'Mux 多路复用';
	@override String get muxDescription => '复用出站连接以减少握手开销';
}
...
class TranslationsSettingsGeneralZhCn extends TranslationsSettingsGeneralEn {
	...
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusZhCn batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusZhCn._(_root);
}
...
class TranslationsSettingsAdvancedZhCn extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'VPN 配置文件已重置';
}
...
class TranslationsSettingsNetworkZhCn extends TranslationsSettingsNetworkEn {
	...
	// Translations
	@override String get perAppProxyPageTitle => '分应用线路';
	...
	@override String get perAppProxyLoadFailedMsg => '加载应用列表失败';
	@override String get perAppProxyRetry => '重试';
	@override String get perAppProxyEmptyMsg => '未找到匹配的应用';
	@override String get perAppProxyAndroidOnlyMsg => '仅 Android 支持分应用线路';
...
class TranslationsFailureSingboxZhCn extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => '核心库未安装';
	...
	@override String get startTimeout => '服务启动超时';
}
...
class TranslationsFailureConnectivityZhCn extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => '网络不可用';
...
class TranslationsFailureProfilesZhCn extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => '没有激活的订阅';
	@override String get invalidConfig => '无效配置';
...
class TranslationsConfigServiceModesZhCn extends TranslationsConfigServiceModesEn {
	...
	// Translations
	@override String get proxy => '仅线路';
	@override String get systemProxy => '系统线路';
	@override String get tun => 'VPN';
...
class TranslationsConfigWarpDetourModesZhCn extends TranslationsConfigWarpDetourModesEn {
	...
	// Translations
	@override String get proxyOverWarp => '通过 WARP 连接线路';
	@override String get warpOverProxy => '通过线路连接 WARP';
	@override String get inbound => '通过线路绕过 WARP';
	@override String get outbound => '通过 WARP 绕过线路';
}
...
class TranslationsSettingsGeneralThemeModesZhCn extends TranslationsSettingsGeneralThemeModesEn {
	...
	// Translations
	@override String get system => '跟随系统颜色';
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusZhCn extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusZhCn._(TranslationsZhCn root) : this._root = root, super._(root);

	@override final TranslationsZhCn _root; // ignore: unused_field

	// Translations
	@override String get exempted => '已豁免';
	@override String get notExempted => '未豁免';
	@override String get pending => '…';
}
...
class TranslationsGeneralZhTw extends TranslationsGeneralEn {
	...
	@override String get underDevelopment => '功能開發中';
...
class TranslationsHomeZhTw extends TranslationsHomeEn {
	...
	@override late final TranslationsHomeRoutingModeZhTw routingMode = TranslationsHomeRoutingModeZhTw._(_root);
	@override String failedToSwitchMode({required Object error}) => '切換模式失敗：${error}';
	@override String get connectionFailedTitle => '連線失敗';
	@override String get coreMissingTitle => '找不到核心程式庫';
	@override String get coreMissingMsg => '應用程式未能載入網路核心程式庫，無法建立連線。請重新安裝應用程式，或確認核心程式庫檔案與主程式在同一目錄下。';
	@override String get degradedTitle => '已連線，但無法存取網路';
	@override String get degradedMsg => '通道已建立，但資料送不出去。可能是節點已失效——試試換一個節點，或者中斷連線。';
	@override String get degradedRetry => '重新檢測';
}
...
class TranslationsStatsZhTw extends TranslationsStatsEn {
	...
	@override String get trafficUsage => '流量使用';
	@override String get liveSpeed => '即時速度';
}
...
class TranslationsProfileZhTw extends TranslationsProfileEn {
	...
	@override late final TranslationsProfileActionButtonsZhTw actionButtons = TranslationsProfileActionButtonsZhTw._(_root);
	@override late final TranslationsProfileDetailsZhTw details = TranslationsProfileDetailsZhTw._(_root);
	@override late final TranslationsProfileOverviewZhTw overview = TranslationsProfileOverviewZhTw._(_root);
	@override String get remoteProfile => '遠端訂閱';
}
...
class TranslationsProxiesZhTw extends TranslationsProxiesEn {
	...
	// Translations
	@override String get pageTitle => '線路';
	@override String get emptyProxiesMsg => '沒有可用的線路';
	@override String get delayTestTooltip => '測試延遲';
	@override String get sortTooltip => '對線路進行排序';
	...
	@override String get activeProxySemanticLabel => '生效中的線路';
	...
	@override String get autoSelectDescription => '自動連線到最快的節點';
	@override String get sortModalTitle => '選擇排序方式';
	@override String testingDelayInfo({required Object name}) => '正在檢測延遲：${name}';
	@override String switchedTo({required Object name}) => '已切換到 ${name}';
	@override String switchToFailed({required Object error}) => '切換失敗：${error}';
	@override String get connectBeforeSwitch => '請先連線再切換線路';
	@override String startDelayTestForGroups({required Object count}) => '已開始檢測 ${count} 條線路的延遲';
	@override String get delayTestBtn => '延遲';
	@override String lineCount({required Object count}) => '${count} 條線路';
	@override String get manualSelect => '手動選擇';
	@override String get autoTest => '自動測速';
}
...
class TranslationsLogsZhTw extends TranslationsLogsEn {
	...
	@override String get clearTooltip => '清除';
	@override String get logsCleared => '日誌已清空';
	@override String get logsCopied => '日誌已複製';
	@override String get logsUnderDevelopment => '日誌功能開發中';
	@override String get noLogsWhenDisconnected => '未連線，無日誌';
}
...
class TranslationsSettingsZhTw extends TranslationsSettingsEn {
	...
	@override String get systemProxyEnabled => '系統代理已啟用';
	@override String get systemProxyDisabled => '系統代理已停用（重新連線後生效）';
	@override String get adminPrivilegesRequired => 'macOS 上需要管理員權限';
	@override String get portChangeNotice => '連接埠變更需要重新連線才會生效';
}
...
class TranslationsAboutZhTw extends TranslationsAboutEn {
	...
	@override String get appDescription => '基於 sing-box 核心的跨平台代理用戶端';
}
...
class TranslationsConnectionZhTw extends TranslationsConnectionEn {
	...
	@override String get staleSystemProxyCleaned => '已清理上次異常結束殘留的系統代理設定';
}
...
class TranslationsConfigZhTw extends TranslationsConfigEn {
	...
	@override String get tproxyPort => '透明線路埠';
	...
	@override String get setSystemProxy => '設定系統線路';
	...
	@override String get warpDetourMode => '鏈式線路';
	...
	@override String get quickSettingsSubtitle => '自訂您的連線體驗';
	@override String get allAdvancedOptions => '所有進階選項';
	@override String get blockAds => '封鎖廣告';
	@override String get warpNoiseSize => '雜訊大小';
	@override String get warpNoiseMode => '雜訊模式';
	@override String get desktopProxyScopeNotice => '桌面端只有遵循系統代理設定的程式會走通道。不遵循的軟體（部分遊戲、命令列工具、自帶代理設定的用戶端）會直連，暴露你的真實 IP。';
}
...
class TranslationsHomeRoutingModeZhTw extends TranslationsHomeRoutingModeEn {
	TranslationsHomeRoutingModeZhTw._(TranslationsZhTw root) : this._root = root, super._(root);

	@override final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get global => '全域代理';
	@override String get smart => '智慧分流';
}
...
class TranslationsProfileAddZhTw extends TranslationsProfileAddEn {
	...
	@override String get modalSubtitle => '選擇新增設定檔的方式';
	@override String get manuallyDescription => '手動輸入伺服器設定';
	@override String get warpDescription => '使用 Cloudflare WARP 免費加速';
}
...
class TranslationsProfileShareZhTw extends TranslationsProfileShareEn {
	...
	@override String get shareLink => '分享連結';
	@override String get subscriptionLinkCopied => '訂閱連結已複製';
	@override String get configCopied => '設定已複製';
...
// Path: profile.actionButtons
class TranslationsProfileActionButtonsZhTw extends TranslationsProfileActionButtonsEn {
	TranslationsProfileActionButtonsZhTw._(TranslationsZhTw root) : this._root = root, super._(root);
	...
	@override String get sort => '排序';
	@override String get copyConfigSuccess => '設定已複製';
	@override String get editConfig => '編輯設定';
}

// Path: profile.details
class TranslationsProfileDetailsZhTw extends TranslationsProfileDetailsEn {
	TranslationsProfileDetailsZhTw._(TranslationsZhTw root) : this._root = root, super._(root);

	@override final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get basicInfo => '基本資訊';
	@override String get subscriptionStatus => '訂閱狀態';
	@override String get options => '選項';
	@override String get updateNow => '立即更新';
	@override String get updateNowDescription => '從伺服器取得最新設定';
...
class TranslationsProfileOverviewZhTw extends TranslationsProfileOverviewEn {
	TranslationsProfileOverviewZhTw._(TranslationsZhTw root) : this._root = root, super._(root);

	@override final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get currentlyUsing => '目前使用中';
	@override String remainingDays({required Object days}) => '剩餘 ${days} 天';
}
...
class TranslationsSettingsGeneralZhTw extends TranslationsSettingsGeneralEn {
	...
	@override late final TranslationsSettingsGeneralBatteryOptimizationStatusZhTw batteryOptimizationStatus = TranslationsSettingsGeneralBatteryOptimizationStatusZhTw._(_root);
}
...
class TranslationsSettingsAdvancedZhTw extends TranslationsSettingsAdvancedEn {
	...
	@override String get resetTunnelSuccess => 'VPN 設定檔已重設';
}
...
class TranslationsSettingsNetworkZhTw extends TranslationsSettingsNetworkEn {
	...
	// Translations
	@override String get perAppProxyPageTitle => '應用程式線路模式';
	...
	@override String get perAppProxyLoadFailedMsg => '載入應用程式清單失敗';
	@override String get perAppProxyRetry => '重試';
	@override String get perAppProxyEmptyMsg => '找不到結果';
	@override String get perAppProxyAndroidOnlyMsg => '分應用線路模式僅支援 Android';
}
...
class TranslationsFailureSingboxZhTw extends TranslationsFailureSingboxEn {
	...
	@override String get coreLibraryMissing => '核心程式庫未安裝';
	@override String get startTimeout => '服務啟動逾時';
}
...
class TranslationsFailureConnectivityZhTw extends TranslationsFailureConnectivityEn {
	...
	@override String get networkUnavailable => '網路無法使用';
}
...
class TranslationsFailureProfilesZhTw extends TranslationsFailureProfilesEn {
	...
	@override String get noActive => '沒有啟用的訂閱';
}
...
class TranslationsConfigServiceModesZhTw extends TranslationsConfigServiceModesEn {
	...
	// Translations
	@override String get proxy => '僅線路';
	@override String get systemProxy => '系統線路';
	@override String get tun => 'VPN';
...
class TranslationsConfigWarpDetourModesZhTw extends TranslationsConfigWarpDetourModesEn {
	...
	// Translations
	@override String get proxyOverWarp => '透過 WARP 連線線路';
	@override String get warpOverProxy => '透過線路連線 WARP';
	@override String get inbound => '透過線路繞過 WARP';
	@override String get outbound => '透過 WARP 繞過線路';
}
...
class TranslationsSettingsGeneralThemeModesZhTw extends TranslationsSettingsGeneralThemeModesEn {
	...
	// Translations
	@override String get system => '跟隨系統顏色';
...
// Path: settings.general.batteryOptimizationStatus
class TranslationsSettingsGeneralBatteryOptimizationStatusZhTw extends TranslationsSettingsGeneralBatteryOptimizationStatusEn {
	TranslationsSettingsGeneralBatteryOptimizationStatusZhTw._(TranslationsZhTw root) : this._root = root, super._(root);
...
class TranslationsSettingsNetworkPerAppProxyModesZhTw extends TranslationsSettingsNetworkPerAppProxyModesEn {
	...
	// Translations
	@override String get off => '全部';
	@override String get offMsg => '透過線路代理所有應用程式';
	@override String get include => '代理';
	@override String get includeMsg => '僅透過線路代理選定的應用程式';
	@override String get exclude => '略過';
	@override String get excludeMsg => '不透過線路代理選定的應用程式';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'general.appTitle': return 'ClashMiao';
			...
			case 'general.underDevelopment': return 'Under Development';
			...
			case 'home.emptyProfilesMsg': return 'No lines yet';
			...
			case 'home.coreMissingTitle': return 'Core Library Not Found';
			case 'home.coreMissingMsg': return 'The app could not load its networking core. Connecting is unavailable. Reinstall the app, or make sure the core library file sits next to the executable.';
			case 'home.degradedTitle': return 'Connected, but no internet access';
			case 'home.degradedMsg': return 'The tunnel is up but traffic is not getting through. The node may be down — try another node, or disconnect.';
			case 'home.degradedRetry': return 'Check again';
			case 'stats.traffic': return 'Traffic';
			case 'stats.trafficLive': return 'Live Traffic';
			case 'stats.trafficTotal': return 'Total Traffic';
			case 'stats.trafficUsage': return 'Traffic Usage';
			case 'stats.liveSpeed': return 'Live Speed';
			...
			case 'profile.actionButtons.add': return 'Add';
			case 'profile.actionButtons.updateAll': return 'Update All';
			case 'profile.actionButtons.sort': return 'Sort';
			case 'profile.actionButtons.copyConfigSuccess': return 'Configuration copied';
			case 'profile.actionButtons.editConfig': return 'Edit Configuration';
			case 'profile.add.buttonText': return 'New Profile';
			case 'profile.add.shortBtnTxt': return 'New Profile';
			case 'profile.add.modalSubtitle': return 'Choose how to add configuration file';
			...
			case 'profile.add.manuallyDescription': return 'Manually enter server configuration';
			case 'profile.add.addWarp': return 'Add Warp';
			case 'profile.add.warpDescription': return 'Free acceleration with Cloudflare WARP';
			...
			case 'profile.details.basicInfo': return 'Basic Information';
			case 'profile.details.subscriptionStatus': return 'Subscription Status';
			case 'profile.details.options': return 'Options';
			case 'profile.details.updateNow': return 'Update Now';
			case 'profile.details.updateNowDescription': return 'Fetch latest configuration from server';
			case 'profile.details.expireDate': return 'Expire Date';
			case 'profile.details.unlimited': return 'Unlimited';
			case 'profile.share.buttonText': return 'Share';
			case 'profile.share.shareLink': return 'Share Link';
			case 'profile.share.subscriptionLinkCopied': return 'Subscription link copied';
			case 'profile.share.configCopied': return 'Configuration copied';
			case 'profile.share.copyFailed': return 'Copy failed';
			...
			case 'profile.overview.currentlyUsing': return 'Currently Using';
			case 'profile.overview.remainingDays': return ({required Object days}) => 'Remaining ${days} days';
			...
			case 'profile.detailsForm.userAgent': return 'User-Agent';
			case 'profile.detailsForm.userAgentNotSet': return 'Not Set';
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.remoteProfile': return 'Remote Profile';
			case 'proxies.pageTitle': return 'Lines';
			case 'proxies.emptyProxiesMsg': return 'No Lines Available';
			case 'proxies.delayTestTooltip': return 'Test Delay';
			case 'proxies.sortTooltip': return 'Sort Lines';
			case 'proxies.checkIp': return 'Check IP';
			case 'proxies.unknownIp': return 'Unknown IP';
			case 'proxies.autoSelect': return 'Auto Select';
			case 'proxies.autoSelectDescription': return 'Auto connect to the fastest node';
			...
			case 'proxies.sortModalTitle': return 'Choose sort method';
			case 'proxies.activeProxySemanticLabel': return 'Active Line';
			...
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'Testing delay for: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'Switched to ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => 'Failed to switch: ${error}';
			case 'proxies.connectBeforeSwitch': return 'Please connect before switching lines';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'Started delay test for ${count} lines';
			case 'proxies.delayTestBtn': return 'Delay';
			case 'proxies.lineCount': return ({required Object count}) => '${count} lines';
			case 'proxies.manualSelect': return 'Manual Select';
			case 'proxies.autoTest': return 'Auto Test';
			...
			case 'logs.logsCleared': return 'Logs cleared';
			case 'logs.logsCopied': return 'Logs copied';
			case 'logs.logsUnderDevelopment': return 'Log feature is under development';
			case 'logs.noLogsWhenDisconnected': return 'Not connected, no logs';
			...
			case 'settings.general.batteryOptimizationStatus.exempted': return 'Exempted';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'Not Exempted';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'VPN profile reset';
			case 'settings.network.perAppProxyPageTitle': return 'Per-App Line Mode';
			case 'settings.network.perAppProxyModes.off': return 'All';
			case 'settings.network.perAppProxyModes.offMsg': return 'Route All Apps Through Line';
			case 'settings.network.perAppProxyModes.include': return 'Route';
			case 'settings.network.perAppProxyModes.includeMsg': return 'Route Only Selected Apps Through Line';
			case 'settings.network.perAppProxyModes.exclude': return 'Bypass';
			case 'settings.network.perAppProxyModes.excludeMsg': return 'Do Not Route Selected Apps Through Line';
			case 'settings.network.perAppProxyLoadFailedMsg': return 'Failed to load app list';
			case 'settings.network.perAppProxyRetry': return 'Retry';
			case 'settings.network.perAppProxyEmptyMsg': return 'No results found';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'Per-app line mode is only supported on Android';
			...
			case 'settings.systemProxyEnabled': return 'System proxy enabled';
			case 'settings.systemProxyDisabled': return 'System proxy disabled (Reconnect to apply)';
			case 'settings.adminPrivilegesRequired': return 'Administrator privileges required on macOS';
			case 'settings.portChangeNotice': return 'Port changes require reconnect to apply';
			...
			case 'about.appDescription': return 'A cross-platform proxy client based on sing-box core';
			...
			case 'tray.hide': return 'Hide to Tray';
			...
			case 'failure.singbox.coreLibraryMissing': return 'Core Library Not Installed';
			...
			case 'failure.singbox.startTimeout': return 'Service Startup Timed Out';
			...
			case 'failure.connectivity.networkUnavailable': return 'Network Unavailable';
			...
			case 'failure.profiles.noActive': return 'No Active Profile';
			...
			case 'play.title': return 'ClashMiao (Preview)';
			case 'play.short_description': return 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
			case 'play.full_description': return 'The key goal of ClashMiao is to provide a secure, user-friendly and efficient tunneling client. It enables you to route all traffic or selected app traffic to a remote server of your choose, utilizing VPN-Service permission.\n\nNote: We do not provide any server; users are required to ensure their online activities stay private by using use their own self-hosted server or trusted servers. \n \nWe Support Servers With:\n- Normal V2Ray/XRay Subscription Link\n- Clash Subscription Link\n- Sing-Box Subscription Link\n\nWhat is our unique features?\n - User Friendly\n - Optimized and Fast\n - Automatically select LowestPing \n - Show user usage information\n - Easily import sublink by one click using deeplinking \n - Free and No ADS\n - Easily switch lines\n - More and more\n\nSupport:\n- All Protocols Supported by Sing-Box \n- VLESS + XTLS Reality, Vision\n- VMess\n- Trojan\n- ShadowSocks\n- Reality\n- WireGuard\n- V2Ray\n- Hysteria2\n- TUICv5\n- SSH\n- ShadowTLS\n\n\nThe source code exist in https://github.com/clashmiao/clashmiao-client\nThe application core is based on open-source Sing-Box.\n\nPermission Description:\n- VPN Service: As the goal of this application is to provide a secure, user-friendly and efficient tunneling client, we need this permission to be able to route the traffic via tunnel to the remote server. \n- QUERY ALL PACKAGES: This permission is used to allow users to include or exclude specific applications for tunneling.\n- RECEIVE BOOT COMPLETED: This permission can be enabled or disabled from app settings to activate this application upon device boot.\n- POST NOTIFICATIONS: This permission is essential as we employ a foreground service to ensure the continuous operation of the VPN service.\n- This application is free from advertisements. The analytics and crash data only occurs with the explicit consent of the user in the first use of application.';
			...
			case 'connection.staleSystemProxyCleaned': return 'Cleaned up system proxy settings left behind by an abnormal exit last time';
			...
			case 'config.quickSettingsSubtitle': return 'Customize your connection experience';
			case 'config.setupWarp': return 'Setup WARP';
			case 'config.allOptions': return 'All Config Options';
			case 'config.allAdvancedOptions': return 'All Advanced Options';
			case 'config.serviceModes.proxy': return 'Line Service Only';
			case 'config.serviceModes.systemProxy': return 'Set System Line';
			case 'config.serviceModes.tun': return 'VPN';
			case 'config.serviceModes.tunService': return 'VPN Service';
			case 'config.shortServiceModes.proxy': return 'Line';
			case 'config.shortServiceModes.systemProxy': return 'System Line';
			...
			case 'config.tproxyPort': return 'Transparent Line Port';
			...
			case 'config.setSystemProxy': return 'Set System Line';
			...
			case 'config.warpDetourModes.proxyOverWarp': return 'Detour Lines Through WARP';
			case 'config.warpDetourModes.warpOverProxy': return 'Detour WARP Through Lines';
			case 'config.warpDetourModes.inbound': return 'Detour WARP Through Lines';
			case 'config.warpDetourModes.outbound': return 'Detour Lines Through WARP';
			...
			case 'config.desktopProxyScopeNotice': return 'On desktop, only apps that honor the system proxy are routed through the tunnel. Software that ignores it (some games, CLI tools, apps with their own proxy settings) connects directly and exposes your real IP.';
			default: return null;
		}
	}
}
...
extension on TranslationsAr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.underDevelopment': return 'قيد التطوير';
			...
			case 'home.routingMode.global': return 'بروكسي عام';
			case 'home.routingMode.smart': return 'توجيه ذكي';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'فشل تبديل الوضع: ${error}';
			case 'home.connectionFailedTitle': return 'فشل الاتصال';
			case 'home.coreMissingTitle': return 'لم يتم العثور على مكتبة النواة';
			case 'home.coreMissingMsg': return 'تعذّر على التطبيق تحميل نواة الشبكة. الاتصال غير متاح. أعد تثبيت التطبيق أو تأكد من وجود ملف مكتبة النواة بجوار الملف التنفيذي.';
			case 'home.degradedTitle': return 'متصل، لكن لا يوجد وصول إلى الإنترنت';
			case 'home.degradedMsg': return 'النفق يعمل لكن البيانات لا تمر. قد يكون الخادم معطلاً — جرّب خادماً آخر أو اقطع الاتصال.';
			case 'home.degradedRetry': return 'إعادة الفحص';
			...
			case 'stats.trafficUsage': return 'استخدام البيانات';
			case 'stats.liveSpeed': return 'السرعة الحالية';
			...
			case 'profile.add.modalSubtitle': return 'اختر طريقة إضافة ملف الإعداد';
			case 'profile.add.manuallyDescription': return 'أدخل إعداد الخادم يدوياً';
			case 'profile.add.addWarp': return 'إضافة WARP';
			case 'profile.add.warpDescription': return 'تسريع مجاني عبر Cloudflare WARP';
			case 'profile.add.addingWarpMsg': return 'يرجى الانتظار أثناء تسجيل WARP.';
			...
			case 'profile.share.shareLink': return 'مشاركة الرابط';
			case 'profile.share.subscriptionLinkCopied': return 'تم نسخ رابط الاشتراك';
			case 'profile.share.configCopied': return 'تم نسخ الإعداد';
			case 'profile.share.copyFailed': return 'فشل النسخ';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'إضافة';
			case 'profile.actionButtons.updateAll': return 'تحديث الكل';
			case 'profile.actionButtons.sort': return 'ترتيب';
			case 'profile.actionButtons.copyConfigSuccess': return 'تم نسخ الإعداد';
			case 'profile.actionButtons.editConfig': return 'تحرير الإعداد';
			case 'profile.details.basicInfo': return 'معلومات أساسية';
			case 'profile.details.subscriptionStatus': return 'حالة الاشتراك';
			case 'profile.details.options': return 'خيارات';
			case 'profile.details.updateNow': return 'تحديث الآن';
			case 'profile.details.updateNowDescription': return 'جلب أحدث إعداد من الخادم';
			case 'profile.details.expireDate': return 'تاريخ الانتهاء';
			case 'profile.details.unlimited': return 'غير محدود';
			case 'profile.overview.currentlyUsing': return 'قيد الاستخدام حالياً';
			case 'profile.overview.remainingDays': return ({required Object days}) => 'متبقٍ ${days} يوماً';
			case 'profile.remoteProfile': return 'اشتراك بعيد';
			...
			case 'proxies.autoSelect': return 'اختيار تلقائي';
			case 'proxies.autoSelectDescription': return 'الاتصال تلقائياً بأسرع خادم';
			case 'proxies.sortModalTitle': return 'اختر طريقة الترتيب';
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'جارٍ اختبار التأخير لـ: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'تم التبديل إلى ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => 'فشل التبديل: ${error}';
			case 'proxies.connectBeforeSwitch': return 'يرجى الاتصال قبل تبديل الخطوط';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'بدأ اختبار التأخير لـ ${count} خط';
			case 'proxies.delayTestBtn': return 'التأخير';
			case 'proxies.lineCount': return ({required Object count}) => '${count} خط';
			case 'proxies.manualSelect': return 'اختيار يدوي';
			case 'proxies.autoTest': return 'اختبار تلقائي';
			...
			case 'logs.logsCleared': return 'تم مسح السجلات';
			case 'logs.logsCopied': return 'تم نسخ السجلات';
			case 'logs.logsUnderDevelopment': return 'ميزة السجلات قيد التطوير';
			case 'logs.noLogsWhenDisconnected': return 'غير متصل، لا توجد سجلات';
			...
			case 'settings.general.batteryOptimizationStatus.exempted': return 'مُستثنى';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'غير مُستثنى';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'تمت إعادة تعيين ملف VPN';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'فشل تحميل قائمة التطبيقات';
			case 'settings.network.perAppProxyRetry': return 'إعادة المحاولة';
			case 'settings.network.perAppProxyEmptyMsg': return 'لا توجد نتائج';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'وضع الخط لكل تطبيق مدعوم على Android فقط';
			...
			case 'settings.systemProxyEnabled': return 'تم تفعيل بروكسي النظام';
			case 'settings.systemProxyDisabled': return 'تم تعطيل بروكسي النظام (أعد الاتصال للتطبيق)';
			case 'settings.adminPrivilegesRequired': return 'يتطلب صلاحيات المسؤول على macOS';
			case 'settings.portChangeNotice': return 'تغييرات المنفذ تتطلب إعادة الاتصال لتفعيلها';
			...
			case 'about.appDescription': return 'عميل بروكسي متعدد المنصات يعتمد على نواة sing-box';
			...
			case 'failure.singbox.coreLibraryMissing': return 'مكتبة النواة غير مثبتة';
			case 'failure.singbox.startTimeout': return 'انتهت مهلة بدء الخدمة';
			...
			case 'failure.connectivity.networkUnavailable': return 'الشبكة غير متاحة';
			...
			case 'failure.profiles.noActive': return 'لا يوجد اشتراك مفعّل';
			...
			case 'play.title': return 'ClashMiao (معاينة)';
			case 'play.short_description': return 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
			case 'play.full_description': return 'الهدف الرئيسي لـ ClashMiao هو توفير عميل نفق آمن وسهل الاستخدام وكفاءة. يمكّنك من توجيه جميع حركة المرور أو حركة المرور من التطبيق المحدد إلى خادم بعيد من اختيارك، باستخدام إذن VPN-Service. \n\nملاحظة: لا نوفر أي خادم، ويتعين على المستخدمين ضمان بقاء أنشطتهم عبر الإنترنت خاصة باستخدام خادمهم المخصص أو الخوادم الموثوقة. \n \nندعم الخوادم مع:\n- رابط اشتراك V2Ray/XRay عادي \n- رابط اشتراك Clash \n- رابط اشتراك Sing-Box \n\nما هي ميزاتنا الفريدة؟\n - سهل الاستخدام \n - مُحسّن وسريع \n - اختيار أدنى Ping تلقائيًا \n - عرض معلومات استخدام المستخدم \n - استيراد sublink بسهولة بنقرة واحدة باستخدام deeplinking \n - مجاني وخالي من الإعلانات \n - تبديل sublinks بسهولة \n - المزيد والمزيد \n\nالدعم:\n- جميع البروتوكولات التي تدعمها Sing-Box \n- VLESS + XTLS Reality, Vision \n- VMess \n- Trojan \n- ShoadowSocks \n- Reality \n- WireGuard \n- V2Ray \n- Hysteria2 \n- TUICv5 \n- SSH \n- ShadowTLS \n\n\nرمز المصدر موجود في https://github.com/clashmiao/clashmiao-client \nتعتمد نواة التطبيق على Sing-Box مفتوحة المصدر.\n\nوصف الإذن:\n- VPN Service: نظرًا لأن هدف هذا التطبيق هو توفير عميل نفق آمن وسهل الاستخدام وكفاءة، نحتاج إلى هذا الإذن لنتمكن من توجيه حركة المرور عبر النفق إلى الخادم البعيد. \n- QUERY ALL PACKAGES: يستخدم هذا الإذن للسماح للمستخدمين بتضمين أو استبعاد تطبيقات محددة للأنفاق. \n- RECEIVE BOOT COMPLETED: يمكن تمكين أو تعطيل هذا الإذن من إعدادات التطبيق لتنشيط هذا التطبيق عند تشغيل الجهاز. \n- POST NOTIFICATIONS: هذا الإذن ضروري لأننا نستخدم خدمة المقدمة لضمان تشغيل خدمة VPN بشكل مستمر. \n- هذا التطبيق خالي من الإعلانات. يتم جمع التحليلات وبيانات الأعطال فقط بموافقة صريحة من المستخدم في أول استخدام للتطبيق.';
			...
			case 'connection.staleSystemProxyCleaned': return 'تم تنظيف إعدادات وكيل النظام المتبقية من إنهاء غير طبيعي سابق';
			...
			case 'config.quickSettingsSubtitle': return 'خصص تجربة الاتصال';
			case 'config.allAdvancedOptions': return 'جميع الخيارات المتقدمة';
			case 'config.blockAds': return 'حظر الإعلانات';
			case 'config.warpNoiseSize': return 'حجم الضجيج';
			case 'config.warpNoiseMode': return 'وضع الضجيج';
			case 'config.desktopProxyScopeNotice': return 'على سطح المكتب، يتم توجيه التطبيقات التي تحترم بروكسي النظام فقط عبر النفق. البرامج التي تتجاهله (بعض الألعاب وأدوات سطر الأوامر والتطبيقات ذات إعدادات البروكسي الخاصة) تتصل مباشرة وتكشف عنوان IP الحقيقي.';
			default: return null;
		}
	}
}
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.clipboardExportSuccessMsg': return 'Copiado al portapapeles';
			case 'general.openAppSettings': return 'Abrir ajustes de la app';
			case 'general.underDevelopment': return 'En desarrollo';
			...
			case 'home.routingMode.global': return 'Proxy global';
			case 'home.routingMode.smart': return 'Enrutamiento inteligente';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'Error al cambiar de modo: ${error}';
			case 'home.connectionFailedTitle': return 'Error de conexión';
			case 'home.coreMissingTitle': return 'No se encontró la biblioteca del núcleo';
			case 'home.coreMissingMsg': return 'La aplicación no pudo cargar su núcleo de red. La conexión no está disponible. Reinstala la aplicación o asegúrate de que el archivo de la biblioteca del núcleo esté junto al ejecutable.';
			case 'home.degradedTitle': return 'Conectado, pero sin acceso a Internet';
			case 'home.degradedMsg': return 'El túnel está activo pero el tráfico no pasa. Puede que el nodo esté caído: prueba otro nodo o desconéctate.';
			case 'home.degradedRetry': return 'Comprobar de nuevo';
			...
			case 'profile.subscription.upload': return 'Subida';
			case 'profile.subscription.download': return 'Descarga';
			case 'profile.subscription.total': return 'Tráfico total';
			case 'profile.subscription.expireDate': return 'Fecha de vencimiento';
			...
			case 'profile.add.qrScanner.permissionRequest': return 'Permiso de cámara para escanear el código QR';
			...
			case 'profile.add.modalSubtitle': return 'Elige cómo añadir el archivo de configuración';
			case 'profile.add.manuallyDescription': return 'Introduce la configuración del servidor manualmente';
			case 'profile.add.addWarp': return 'Añadir WARP';
			case 'profile.add.warpDescription': return 'Aceleración gratuita con Cloudflare WARP';
			case 'profile.add.addingWarpMsg': return 'Espera mientras registramos WARP.';
			...
			case 'profile.share.shareLink': return 'Compartir enlace';
			case 'profile.share.subscriptionLinkCopied': return 'Enlace de suscripción copiado';
			case 'profile.share.configCopied': return 'Configuración copiada';
			case 'profile.share.copyFailed': return 'Error al copiar';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'Añadir';
			case 'profile.actionButtons.updateAll': return 'Actualizar todo';
			case 'profile.actionButtons.sort': return 'Ordenar';
			case 'profile.actionButtons.copyConfigSuccess': return 'Configuración copiada';
			case 'profile.actionButtons.editConfig': return 'Editar configuración';
			case 'profile.details.basicInfo': return 'Información básica';
			case 'profile.details.subscriptionStatus': return 'Estado de la suscripción';
			case 'profile.details.options': return 'Opciones';
			case 'profile.details.updateNow': return 'Actualizar ahora';
			case 'profile.details.updateNowDescription': return 'Obtener la configuración más reciente del servidor';
			case 'profile.details.expireDate': return 'Fecha de vencimiento';
			case 'profile.details.unlimited': return 'Ilimitado';
			case 'profile.overview.currentlyUsing': return 'En uso';
			case 'profile.overview.remainingDays': return ({required Object days}) => 'Quedan ${days} días';
			case 'profile.remoteProfile': return 'Perfil remoto';
			...
			case 'proxies.autoSelect': return 'Selección automática';
			case 'proxies.autoSelectDescription': return 'Conectar automáticamente al nodo más rápido';
			case 'proxies.sortModalTitle': return 'Elige el método de ordenación';
			case 'proxies.activeProxySemanticLabel': return 'Línea activa';
			case 'proxies.delaySemantics.result': return ({required Object delay}) => 'Latencia: ${delay} ms';
			case 'proxies.delaySemantics.timeout': return 'Tiempo de prueba de latencia agotado';
			case 'proxies.delaySemantics.testing': return 'Latencia: probando...';
			case 'proxies.ipInfoSemantics.address': return 'Dirección IP';
			case 'proxies.ipInfoSemantics.country': return 'País';
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'Probando latencia de: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'Cambiado a ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => 'Error al cambiar: ${error}';
			case 'proxies.connectBeforeSwitch': return 'Conéctate antes de cambiar de línea';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'Prueba de latencia iniciada para ${count} líneas';
			case 'proxies.delayTestBtn': return 'Latencia';
			case 'proxies.lineCount': return ({required Object count}) => '${count} líneas';
			case 'proxies.manualSelect': return 'Selección manual';
			case 'proxies.autoTest': return 'Prueba automática';
			...
			case 'logs.logsCleared': return 'Registros borrados';
			case 'logs.logsCopied': return 'Registros copiados';
			case 'logs.logsUnderDevelopment': return 'La función de registros está en desarrollo';
			case 'logs.noLogsWhenDisconnected': return 'Sin conexión, no hay registros';
			...
			case 'settings.general.autoIpCheck': return 'Comprobar automáticamente la IP de conexión';
			case 'settings.general.batteryOptimizationStatus.exempted': return 'Exento';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'No exento';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'Perfil VPN restablecido';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'Error al cargar la lista de aplicaciones';
			case 'settings.network.perAppProxyRetry': return 'Reintentar';
			case 'settings.network.perAppProxyEmptyMsg': return 'No se encontraron resultados';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'El modo de línea por aplicación solo es compatible con Android';
			...
			case 'settings.importOptionsMsg': return 'Esto sobrescribirá todas las opciones de configuración con los valores proporcionados. ¿Continuar?';
			case 'settings.systemProxyEnabled': return 'Proxy del sistema activado';
			case 'settings.systemProxyDisabled': return 'Proxy del sistema desactivado (reconecta para aplicar)';
			case 'settings.adminPrivilegesRequired': return 'Se requieren privilegios de administrador en macOS';
			case 'settings.portChangeNotice': return 'Los cambios de puerto requieren reconectar para aplicarse';
			...
			case 'about.appDescription': return 'Un cliente proxy multiplataforma basado en el núcleo sing-box';
			...
			case 'failure.singbox.coreLibraryMissing': return 'Biblioteca del núcleo no instalada';
			case 'failure.singbox.startTimeout': return 'Tiempo de inicio del servicio agotado';
			...
			case 'failure.connectivity.networkUnavailable': return 'Red no disponible';
			...
			case 'failure.profiles.noActive': return 'Sin perfil activo';
			...
			case 'play.title': return 'ClashMiao Next (vista previa)';
			case 'play.short_description': return 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
			...
			case 'connection.staleSystemProxyCleaned': return 'Se limpiaron los ajustes de proxy del sistema que quedaron de una salida anómala';
			...
			case 'config.warpDetourModes.proxyOverWarp': return 'Desviar líneas a través de WARP';
			case 'config.warpDetourModes.warpOverProxy': return 'Desviar WARP a través de las líneas';
			case 'config.warpLicenseKey': return 'License Key';
			case 'config.warpCleanIp': return 'Clean IP';
			case 'config.warpPort': return 'Port';
			case 'config.warpNoise': return 'Noise';
			case 'config.quickSettings': return 'Ajustes rápidos';
			case 'config.quickSettingsSubtitle': return 'Personaliza tu experiencia de conexión';
			case 'config.setupWarp': return 'Configurar WARP';
			case 'config.allOptions': return 'Todas las opciones de configuración';
			case 'config.allAdvancedOptions': return 'Todas las opciones avanzadas';
			case 'config.shortServiceModes.proxy': return 'Solo línea';
			case 'config.shortServiceModes.systemProxy': return 'Línea del sistema';
			case 'config.shortServiceModes.tun': return 'VPN';
			...
			case 'config.warpConfigGenerated': return 'Configuración WARP generada';
			case 'config.blockAds': return 'Bloquear anuncios';
			case 'config.tproxyPort': return 'Puerto de línea transparente';
			case 'config.warpNoiseSize': return 'Tamaño del ruido';
			case 'config.warpNoiseMode': return 'Modo de ruido';
			case 'config.warpNoiseDelay': return 'Retardo de ruido';
			case 'config.desktopProxyScopeNotice': return 'En el escritorio, solo las aplicaciones que respetan el proxy del sistema pasan por el túnel. El software que lo ignora (algunos juegos, herramientas de línea de comandos, aplicaciones con su propia configuración de proxy) se conecta directamente y expone tu IP real.';
			case 'stats.traffic': return 'Tráfico';
			case 'stats.trafficLive': return 'Tráfico en vivo';
			case 'stats.trafficTotal': return 'Tráfico total';
			case 'stats.trafficUsage': return 'Uso de tráfico';
			case 'stats.liveSpeed': return 'Velocidad en vivo';
			case 'stats.uplink': return 'Subida';
			case 'stats.downlink': return 'Bajada';
...
extension on TranslationsFa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.underDevelopment': return 'در حال توسعه';
			case 'general.confirm': return 'تأیید';
			case 'intro.termsAndPolicyCaution': return ({required InlineSpanBuilder tap}) => TextSpan(children: [
				const TextSpan(text: 'در صورت ادامه با '),
				tap(_root.about.termsAndConditions),
				const TextSpan(text: ' موافقت می‌کنید'),
			...
			case 'home.routingMode.global': return 'پروکسی سراسری';
			case 'home.routingMode.smart': return 'مسیریابی هوشمند';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'تغییر حالت ناموفق بود: ${error}';
			case 'home.connectionFailedTitle': return 'اتصال ناموفق';
			case 'home.coreMissingTitle': return 'کتابخانهٔ هسته پیدا نشد';
			case 'home.coreMissingMsg': return 'برنامه نتوانست هستهٔ شبکهٔ خود را بارگذاری کند. اتصال در دسترس نیست. برنامه را دوباره نصب کنید یا مطمئن شوید فایل کتابخانهٔ هسته کنار فایل اجرایی قرار دارد.';
			case 'home.degradedTitle': return 'متصل است، اما دسترسی به اینترنت وجود ندارد';
			case 'home.degradedMsg': return 'تونل برقرار است اما ترافیک عبور نمی‌کند. ممکن است نود از کار افتاده باشد — نود دیگری را امتحان کنید یا قطع کنید.';
			case 'home.degradedRetry': return 'بررسی مجدد';
			...
			case 'stats.trafficUsage': return 'مصرف ترافیک';
			case 'stats.liveSpeed': return 'سرعت لحظه‌ای';
			...
			case 'profile.add.modalSubtitle': return 'نحوهٔ افزودن فایل پیکربندی را انتخاب کنید';
			case 'profile.add.manuallyDescription': return 'پیکربندی سرور را دستی وارد کنید';
			case 'profile.add.warpDescription': return 'شتاب‌دهی رایگان با Cloudflare WARP';
			...
			case 'profile.share.shareLink': return 'اشتراک‌گذاری پیوند';
			case 'profile.share.subscriptionLinkCopied': return 'پیوند اشتراک کپی شد';
			case 'profile.share.configCopied': return 'پیکربندی کپی شد';
			case 'profile.share.copyFailed': return 'کپی ناموفق بود';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'افزودن';
			case 'profile.actionButtons.updateAll': return 'به‌روزرسانی همه';
			case 'profile.actionButtons.sort': return 'مرتب‌سازی';
			case 'profile.actionButtons.copyConfigSuccess': return 'پیکربندی کپی شد';
			case 'profile.actionButtons.editConfig': return 'ویرایش پیکربندی';
			case 'profile.details.basicInfo': return 'اطلاعات پایه';
			case 'profile.details.subscriptionStatus': return 'وضعیت اشتراک';
			case 'profile.details.options': return 'گزینه‌ها';
			case 'profile.details.updateNow': return 'اکنون به‌روزرسانی کن';
			case 'profile.details.updateNowDescription': return 'دریافت آخرین پیکربندی از سرور';
			case 'profile.details.expireDate': return 'تاریخ انقضا';
			case 'profile.details.unlimited': return 'نامحدود';
			case 'profile.overview.currentlyUsing': return 'در حال استفاده';
			case 'profile.overview.remainingDays': return ({required Object days}) => '${days} روز باقی مانده';
			case 'profile.remoteProfile': return 'پروفایل راه دور';
			...
			case 'proxies.autoSelect': return 'انتخاب خودکار';
			case 'proxies.autoSelectDescription': return 'اتصال خودکار به سریع‌ترین نود';
			case 'proxies.sortModalTitle': return 'روش مرتب‌سازی را انتخاب کنید';
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'در حال آزمایش تأخیر: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'به ${name} تغییر یافت';
			case 'proxies.switchToFailed': return ({required Object error}) => 'تعویض ناموفق بود: ${error}';
			case 'proxies.connectBeforeSwitch': return 'پیش از تعویض خط، متصل شوید';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'آزمایش تأخیر برای ${count} خط آغاز شد';
			case 'proxies.delayTestBtn': return 'تأخیر';
			case 'proxies.lineCount': return ({required Object count}) => '${count} خط';
			case 'proxies.manualSelect': return 'انتخاب دستی';
			case 'proxies.autoTest': return 'تست خودکار';
			...
			case 'logs.logsCleared': return 'گزارش‌ها پاک شد';
			case 'logs.logsCopied': return 'گزارش‌ها کپی شد';
			case 'logs.logsUnderDevelopment': return 'قابلیت گزارش‌گیری در حال توسعه است';
			case 'logs.noLogsWhenDisconnected': return 'متصل نیست، گزارشی وجود ندارد';
			...
			case 'settings.general.batteryOptimizationStatus.exempted': return 'مستثنی';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'مستثنی نشده';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'پروفایل VPN بازنشانی شد';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'بارگذاری فهرست برنامه‌ها ناموفق بود';
			case 'settings.network.perAppProxyRetry': return 'تلاش مجدد';
			case 'settings.network.perAppProxyEmptyMsg': return 'نتیجه‌ای یافت نشد';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'حالت خط برای هر برنامه فقط در Android پشتیبانی می‌شود';
			...
			case 'settings.systemProxyEnabled': return 'پروکسی سیستم فعال شد';
			case 'settings.systemProxyDisabled': return 'پروکسی سیستم غیرفعال شد (برای اعمال، دوباره وصل شوید)';
			case 'settings.adminPrivilegesRequired': return 'در macOS به دسترسی مدیر نیاز است';
			case 'settings.portChangeNotice': return 'تغییر پورت برای اعمال شدن نیاز به اتصال مجدد دارد';
			...
			case 'about.appDescription': return 'یک کلاینت پروکسی چندسکویی مبتنی بر هستهٔ sing-box';
			...
			case 'tray.hide': return 'پنهان کردن';
			...
			case 'failure.singbox.coreLibraryMissing': return 'کتابخانهٔ هسته نصب نشده است';
			case 'failure.singbox.startTimeout': return 'زمان راه‌اندازی سرویس به پایان رسید';
			...
			case 'failure.connectivity.networkUnavailable': return 'شبکه در دسترس نیست';
			...
			case 'failure.profiles.noActive': return 'هیچ پروفایل فعالی وجود ندارد';
			...
			case 'play.title': return 'ClashMiao (آزمایشی)';
			case 'play.short_description': return 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
			case 'play.full_description': return 'هدف اصلی ClashMiao ارائه یک کلاینت ضدفیلتر ایمن، کاربرپسند و کارآمد است. این به شما امکان می‌دهد تا با استفاده از مجوز سرویس VPN، تمام ترافیک یا ترافیک برنامه‌ی انتخابی را به یک سرور راه دور مورد نظر خود هدایت کنید.\n\nتوجه: ما هیچ سروری ارائه نمی‌دهیم. کاربران موظف هستند با استفاده از سرورهای خود، هاست یا سرورهای مورد اعتماد، فعالیت‌های آنلاین خود را خصوصی نگه دارند. \n\nما از این سرورها پشتیبانی می‌کنیم:\n- لینک اشتراک V2Ray/XRay معمولی\n- لینک اشتراک کلش\n- لینک اشتراک Sing-Box\n\nویژگی‌های منحصر به فرد این برنامه چیست؟\n- کاربر پسند  \n- بهینه و سریع  \n- انتخاب کمترین پینگ به صورت خودکار\n- نمایش اطلاعات استفاده کاربر\n- به راحتی لینک فرعی را با یک کلیک با استفاده از دیپ لینک وارد کنید  \n- رایگان و بدون تبلیغات  \n- به‌راحتی لینک های فرعی کاربر را تغییر دهید  \n- بیشتر و بیشتر\n\nپشتیبانی از:\n- همه‌ی پروتکل‌های پشتیبانی‌شده توسط Sing-Box- VLESS + XTLS Reality، Vision- VMess- Trojan- ShadowSocks- Reality- WireGuard- V2Ray- Hysteria2- TUICv5- SSH- ShadowTLS\n\nکد منبع در https://github.com/clashmiao/clashmiao-client موجود بوده و هسته‌ی برنامه مبتنی بر منبع باز Sing-Box است.\n\nتوضیحات مجوز:\n- VPN Service: از آن‌جا که هدف این برنامه ارائه‌ی یک کلاینت ضدفیلتر ایمن، کاربر پسند و کارآمد است، ما به این مجوز نیاز داریم تا بتوانیم ترافیک را از طریق تونل به سرور راه دور هدایت کنیم.\n- QUERY ALL PACKAGES: این مجوز برای اجازه دادن به کاربران برای گنجاندن یا حذف برنامه‌های کاربردی خاص برای تونل‌زدن استفاده می‌شود.\n- RECEIVE BOOT COMPLETED: این مجوز را می‌توان از تنظیمات برنامه فعال یا غیرفعال کرد تا این برنامه پس از شروع به کار دستگاه فعال شود.\n- POST NOTIFICATIONS: این مجوز ضروری است زیرا برای اطمینان از عملکرد یکسره VPN نیاز است از یک سرویس پس زمینه استفاده کنیم. \n- این برنامه بدون تبلیغات است. تجزیه و تحلیل و داده‌های خرابی فقط با رضایت صریح کاربر در اولین استفاده از برنامه اتفاق می‌افتد.';
			...
			case 'connection.staleSystemProxyCleaned': return 'تنظیمات پروکسی سیستم که از خروج غیرعادی قبلی باقی مانده بود پاک شد';
			...
			case 'config.quickSettingsSubtitle': return 'تجربهٔ اتصال خود را سفارشی کنید';
			case 'config.allAdvancedOptions': return 'همهٔ گزینه‌های پیشرفته';
			case 'config.desktopProxyScopeNotice': return 'در دسکتاپ، فقط برنامه‌هایی که پروکسی سیستم را رعایت می‌کنند از تونل عبور می‌کنند. نرم‌افزارهایی که آن را نادیده می‌گیرند (برخی بازی‌ها، ابزارهای خط فرمان، برنامه‌های دارای تنظیمات پروکسی مستقل) مستقیم وصل می‌شوند و IP واقعی شما را افشا می‌کنند.';
			default: return null;
		}
	}
}
...
extension on TranslationsId {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.clipboardExportSuccessMsg': return 'Disalin ke papan klip';
			case 'general.showMore': return 'Tampilkan Lebih Banyak';
			case 'general.showLess': return 'Tampilkan Lebih Sedikit';
			case 'general.openAppSettings': return 'Buka Pengaturan Aplikasi';
			case 'general.grantPermission': return 'Berikan Izin';
			case 'general.underDevelopment': return 'Dalam Pengembangan';
			case 'general.confirm': return 'Konfirmasi';
			case 'intro.termsAndPolicyCaution': return ({required InlineSpanBuilder tap}) => TextSpan(children: [
				const TextSpan(text: 'lanjut berarti setuju dengan '),
				tap(_root.about.termsAndConditions),
			]);
			...
			case 'home.routingMode.global': return 'Proxy Global';
			case 'home.routingMode.smart': return 'Perutean Cerdas';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'Gagal mengganti mode: ${error}';
			case 'home.connectionFailedTitle': return 'Koneksi Gagal';
			case 'home.coreMissingTitle': return 'Pustaka Inti Tidak Ditemukan';
			case 'home.coreMissingMsg': return 'Aplikasi tidak dapat memuat inti jaringannya. Koneksi tidak tersedia. Pasang ulang aplikasi, atau pastikan berkas pustaka inti berada di samping berkas eksekusi.';
			case 'home.degradedTitle': return 'Tersambung, tetapi tidak ada akses internet';
			case 'home.degradedMsg': return 'Terowongan aktif tetapi lalu lintas tidak tersalur. Node mungkin mati — coba node lain, atau putuskan koneksi.';
			case 'home.degradedRetry': return 'Periksa Lagi';
			...
			case 'stats.trafficUsage': return 'Penggunaan Lalu Lintas';
			case 'stats.liveSpeed': return 'Kecepatan Langsung';
			case 'stats.speed': return 'Kecepatan';
			case 'stats.totalTransferred': return 'Total Ditransfer';
			...
			case 'profile.subscription.upload': return 'Unggah';
			case 'profile.subscription.download': return 'Unduh';
			case 'profile.subscription.total': return 'Total Lalu Lintas';
			case 'profile.subscription.expireDate': return 'Tanggal Kedaluwarsa';
			...
			case 'profile.add.qrScanner.permissionRequest': return 'Izin kamera untuk memindai Kode QR';
			...
			case 'profile.add.modalSubtitle': return 'Pilih cara menambahkan berkas konfigurasi';
			case 'profile.add.manuallyDescription': return 'Masukkan konfigurasi server secara manual';
			case 'profile.add.addWarp': return 'Tambah WARP';
			case 'profile.add.warpDescription': return 'Akselerasi gratis dengan Cloudflare WARP';
			case 'profile.add.addingWarpMsg': return 'Mohon tunggu, kami sedang mendaftarkan WARP.';
			...
			case 'profile.share.shareLink': return 'Bagikan Tautan';
			case 'profile.share.subscriptionLinkCopied': return 'Tautan langganan disalin';
			case 'profile.share.configCopied': return 'Konfigurasi disalin';
			case 'profile.share.copyFailed': return 'Gagal menyalin';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'Tambah';
			case 'profile.actionButtons.updateAll': return 'Perbarui Semua';
			case 'profile.actionButtons.sort': return 'Urutkan';
			case 'profile.actionButtons.copyConfigSuccess': return 'Konfigurasi disalin';
			case 'profile.actionButtons.editConfig': return 'Edit Konfigurasi';
			case 'profile.details.basicInfo': return 'Informasi Dasar';
			case 'profile.details.subscriptionStatus': return 'Status Langganan';
			case 'profile.details.options': return 'Opsi';
			case 'profile.details.updateNow': return 'Perbarui Sekarang';
			case 'profile.details.updateNowDescription': return 'Ambil konfigurasi terbaru dari server';
			case 'profile.details.expireDate': return 'Tanggal Kedaluwarsa';
			case 'profile.details.unlimited': return 'Tanpa Batas';
			case 'profile.overview.currentlyUsing': return 'Sedang Digunakan';
			case 'profile.overview.remainingDays': return ({required Object days}) => 'Sisa ${days} hari';
			case 'profile.remoteProfile': return 'Profil Jarak Jauh';
			...
			case 'proxies.unknownIp': return 'IP Tidak Diketahui';
			case 'proxies.autoSelect': return 'Pilih Otomatis';
			case 'proxies.autoSelectDescription': return 'Sambungkan otomatis ke node tercepat';
			case 'proxies.sortModalTitle': return 'Pilih metode pengurutan';
			case 'proxies.activeProxySemanticLabel': return 'Jalur Aktif';
			case 'proxies.delaySemantics.result': return ({required Object delay}) => 'Jeda: ${delay}ms';
			case 'proxies.delaySemantics.timeout': return 'Waktu Uji Jeda Habis';
			case 'proxies.delaySemantics.testing': return 'Jeda: Menguji...';
			case 'proxies.ipInfoSemantics.address': return 'Alamat IP';
			case 'proxies.ipInfoSemantics.country': return 'Negara';
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'Menguji jeda untuk: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'Beralih ke ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => 'Gagal beralih: ${error}';
			case 'proxies.connectBeforeSwitch': return 'Sambungkan terlebih dahulu sebelum mengganti jalur';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'Uji jeda dimulai untuk ${count} jalur';
			case 'proxies.delayTestBtn': return 'Jeda';
			case 'proxies.lineCount': return ({required Object count}) => '${count} jalur';
			case 'proxies.manualSelect': return 'Pilih Manual';
			case 'proxies.autoTest': return 'Tes Otomatis';
			...
			case 'logs.logsCleared': return 'Log dihapus';
			case 'logs.logsCopied': return 'Log disalin';
			case 'logs.logsUnderDevelopment': return 'Fitur log sedang dikembangkan';
			case 'logs.noLogsWhenDisconnected': return 'Tidak tersambung, tidak ada log';
			...
			case 'settings.general.autoIpCheck': return 'Periksa IP Koneksi Otomatis';
			case 'settings.general.batteryOptimizationStatus.exempted': return 'Dikecualikan';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'Tidak Dikecualikan';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'Profil VPN telah direset';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'Gagal memuat daftar aplikasi';
			case 'settings.network.perAppProxyRetry': return 'Coba Lagi';
			case 'settings.network.perAppProxyEmptyMsg': return 'Tidak ada hasil';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'Mode jalur per aplikasi hanya didukung di Android';
			...
			case 'settings.exportAllOptions': return 'Salin Semua Opsi ke Papan Klip';
			case 'settings.importOptions': return 'Impor Opsi dari Papan Klip';
			case 'settings.importOptionsMsg': return 'Ini akan menimpa semua opsi konfigurasi dengan nilai yang diberikan. Anda yakin?';
			case 'settings.systemProxyEnabled': return 'Proxy sistem diaktifkan';
			case 'settings.systemProxyDisabled': return 'Proxy sistem dinonaktifkan (sambung ulang untuk menerapkan)';
			case 'settings.adminPrivilegesRequired': return 'Memerlukan hak administrator di macOS';
			case 'settings.portChangeNotice': return 'Perubahan port memerlukan sambung ulang agar berlaku';
			...
			case 'about.appDescription': return 'Klien proxy lintas platform berbasis inti sing-box';
			...
			case 'tray.hide': return 'Sembunyikan';
			...
			case 'failure.singbox.coreLibraryMissing': return 'Pustaka Inti Belum Terpasang';
			case 'failure.singbox.startTimeout': return 'Waktu Mulai Layanan Habis';
			...
			case 'failure.connectivity.networkUnavailable': return 'Jaringan Tidak Tersedia';
			...
			case 'failure.profiles.noActive': return 'Tidak Ada Profil Aktif';
			...
			case 'play.full_description': return 'Tujuan utama ClashMiao adalah memberikan keamanan, user-friendly dan client tunnel yg efisien. ClashMiao mengizinkanmu untuk mengarahkan semua atau beberapa trafik data aplikasi terpilih ke server remot pilihanmu, memanfaatkan izin VPN-Service.\n\nNote: Kami tidak menyediakan server apapun; pengguna diwajibkan untuk memastikan aktivitas online mereka tetap private dengan menggunakan self-hosted server atau server yg dipercaya pilihan mereka sendiri. \n \nKami mendukung server dengan:\n- Normal V2ray/Xray Subscription Link\n- Clash Subscription Link\n- Sing-Box Subscription Link\n\nApa fitur unik kami?\n - User Friendly\n - Cepat dan teroptimasi\n - Otomatis pilihan PING terendah \n - Menampilkan informasi penggunaan user\n - Dengan mudah import sublink dengan satu klik menggunakan deeplinking \n - Bebas dan tanpa iklan\n - Dengan mudah berganti user sublink\n - dan sebagainya\n\nSupport:\n- Semua protokol di dukung oleh Sing-Box \n- VLESS + xtls reality, vision\n- VMESS\n- Trojan\n- ShadowSocks\n- Reality\n- V2ray\n- Hystria2\n- TUIC\n- SSH\n- ShadowTLS\n\n\nCode Sumber ada di https://github.com/clashmiao/clashmiao-client\nInti Aplikasi didasarkan pada Sing-Box Open Source.\n\nDeskripsi Izin:\n- VPN Servis: Tujuan aplikasi ini menyediakan keamanan, user-friendly dan tunneling client efisien, kami membutuhkan izin untuk bisa mengarahkan traffic data melalui kanal remot server. \n- QUERY ALL PACKAGES: izin ini digunakan untuk memperbolehkan pengguna masuk atau mengeluarkan aplikasi tertentu untuk tunneling.\n- RECEIVE BOOT COMPLETED: izin ini dapat diaktifkan atau dinonaktifkan dari setting aplikasi untuk mengaktikan aplikasi ini saat boot device.\n- POST NOTIFICATIONS: izin ini penting karena kami menggunakan foreground service untuk memastikan operasi berkelanjutan dari VPN Servis.\n- Aplikasi ini bebas dari iklan. Analitik dan data crash hanya terjadi dengan persetujuan eksplisit dari pengguna pada saat penggunaan pertama kali';
			...
			case 'connection.reconnect': return 'Sambungkan Ulang';
			case 'connection.connectAnyWay': return 'Sambungkan';
			case 'connection.reconnectMsg': return 'Menyambungkan ulang untuk menerapkan perubahan...';
			case 'connection.staleSystemProxyCleaned': return 'Pengaturan proxy sistem yang tertinggal dari keluar tidak normal telah dibersihkan';
			...
			case 'config.warpDetourModes.inbound': return 'Detour WARP through proxies';
			case 'config.warpDetourModes.outbound': return 'Detour proxies through WARP';
			case 'config.warpDetourModes.proxyOverWarp': return 'Alihkan Jalur Melalui WARP';
			case 'config.warpDetourModes.warpOverProxy': return 'Alihkan WARP Melalui Jalur';
			case 'config.warpLicenseKey': return 'License Key';
			case 'config.warpCleanIp': return 'Clean IP';
			case 'config.warpPort': return 'Port';
			case 'config.warpNoise': return 'Noise';
			case 'config.quickSettings': return 'Pengaturan Cepat';
			case 'config.quickSettingsSubtitle': return 'Sesuaikan pengalaman koneksi Anda';
			case 'config.setupWarp': return 'Siapkan WARP';
			case 'config.allOptions': return 'Semua Opsi Konfigurasi';
			case 'config.allAdvancedOptions': return 'Semua Opsi Lanjutan';
			case 'config.shortServiceModes.proxy': return 'Hanya Jalur';
			case 'config.shortServiceModes.systemProxy': return 'Jalur Sistem';
			case 'config.shortServiceModes.tun': return 'VPN';
			case 'config.shortServiceModes.tunService': return 'Layanan VPN';
			case 'config.generateWarpConfig': return 'Buat Konfigurasi WARP';
			...
			case 'config.tproxyPort': return 'Port Jalur Transparan';
			case 'config.warpNoiseSize': return 'Ukuran Noise';
			case 'config.warpNoiseMode': return 'Mode Noise';
			case 'config.warpNoiseDelay': return 'Penundaan Noise';
			case 'config.desktopProxyScopeNotice': return 'Di desktop, hanya aplikasi yang mematuhi proxy sistem yang dialihkan melalui terowongan. Perangkat lunak yang mengabaikannya (beberapa game, alat baris perintah, aplikasi dengan pengaturan proxy sendiri) terhubung langsung dan membocorkan IP asli Anda.';
			default: return null;
		}
	}
}
...
extension on TranslationsPtBr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.clipboardExportSuccessMsg': return 'Copiado para a área de transferência';
			case 'general.openAppSettings': return 'Abrir configurações do app';
			case 'general.underDevelopment': return 'Em desenvolvimento';
			case 'general.confirm': return 'Confirmar';
			case 'intro.termsAndPolicyCaution': return ({required InlineSpanBuilder tap}) => TextSpan(children: [
				const TextSpan(text: 'ao continuar você concorda com '),
				tap(' ${_root.about.termsAndConditions}'),
			...
			case 'home.routingMode.global': return 'Proxy global';
			case 'home.routingMode.smart': return 'Roteamento inteligente';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'Falha ao alternar o modo: ${error}';
			case 'home.connectionFailedTitle': return 'Falha na conexão';
			case 'home.coreMissingTitle': return 'Biblioteca do núcleo não encontrada';
			case 'home.coreMissingMsg': return 'O aplicativo não conseguiu carregar seu núcleo de rede. A conexão não está disponível. Reinstale o aplicativo ou verifique se o arquivo da biblioteca do núcleo está junto do executável.';
			case 'home.degradedTitle': return 'Conectado, mas sem acesso à internet';
			case 'home.degradedMsg': return 'O túnel está ativo, mas o tráfego não passa. O nó pode estar fora do ar — tente outro nó ou desconecte.';
			case 'home.degradedRetry': return 'Verificar novamente';
			...
			case 'stats.trafficUsage': return 'Uso de tráfego';
			case 'stats.liveSpeed': return 'Velocidade ao vivo';
			...
			case 'profile.add.qrScanner.permissionRequest': return 'Permissão de câmera para ler o código QR';
			case 'profile.add.manually': return 'Entrada manual';
			case 'profile.add.addingProfileMsg': return 'Adicionando Perfil';
			case 'profile.add.failureMsg': return 'Falha ao adicionar perfil';
			case 'profile.add.modalSubtitle': return 'Escolha como adicionar o arquivo de configuração';
			case 'profile.add.manuallyDescription': return 'Insira a configuração do servidor manualmente';
			case 'profile.add.addWarp': return 'Adicionar WARP';
			case 'profile.add.warpDescription': return 'Aceleração gratuita com Cloudflare WARP';
			...
			case 'profile.share.shareLink': return 'Compartilhar link';
			case 'profile.share.subscriptionLinkCopied': return 'Link de assinatura copiado';
			case 'profile.share.configCopied': return 'Configuração copiada';
			case 'profile.share.copyFailed': return 'Falha ao copiar';
			case 'profile.edit.buttonTxt': return 'Editar';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'Adicionar';
			case 'profile.actionButtons.updateAll': return 'Atualizar tudo';
			case 'profile.actionButtons.sort': return 'Ordenar';
			case 'profile.actionButtons.copyConfigSuccess': return 'Configuração copiada';
			case 'profile.actionButtons.editConfig': return 'Editar configuração';
			case 'profile.details.basicInfo': return 'Informações básicas';
			case 'profile.details.subscriptionStatus': return 'Status da assinatura';
			case 'profile.details.options': return 'Opções';
			case 'profile.details.updateNow': return 'Atualizar agora';
			case 'profile.details.updateNowDescription': return 'Buscar a configuração mais recente no servidor';
			case 'profile.details.expireDate': return 'Data de expiração';
			case 'profile.details.unlimited': return 'Ilimitado';
			case 'profile.overview.currentlyUsing': return 'Em uso';
			case 'profile.overview.remainingDays': return ({required Object days}) => 'Restam ${days} dias';
			case 'profile.remoteProfile': return 'Perfil remoto';
			case 'proxies.pageTitle': return 'Proxies';
			...
			case 'proxies.ipInfoSemantics.country': return 'País';
			case 'proxies.autoSelect': return 'Seleção automática';
			case 'proxies.autoSelectDescription': return 'Conectar automaticamente ao nó mais rápido';
			case 'proxies.sortModalTitle': return 'Escolha o método de ordenação';
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'Testando latência de: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'Alterado para ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => 'Falha ao trocar: ${error}';
			case 'proxies.connectBeforeSwitch': return 'Conecte-se antes de trocar de linha';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'Teste de latência iniciado para ${count} linhas';
			case 'proxies.delayTestBtn': return 'Latência';
			case 'proxies.lineCount': return ({required Object count}) => '${count} linhas';
			case 'proxies.manualSelect': return 'Seleção manual';
			case 'proxies.autoTest': return 'Teste automático';
			...
			case 'logs.logsCleared': return 'Registros limpos';
			case 'logs.logsCopied': return 'Registros copiados';
			case 'logs.logsUnderDevelopment': return 'O recurso de registros está em desenvolvimento';
			case 'logs.noLogsWhenDisconnected': return 'Desconectado, sem registros';
			...
			case 'settings.general.batteryOptimizationStatus.exempted': return 'Isento';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'Não isento';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'Perfil de VPN redefinido';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'Falha ao carregar a lista de aplicativos';
			case 'settings.network.perAppProxyRetry': return 'Tentar novamente';
			case 'settings.network.perAppProxyEmptyMsg': return 'Nenhum resultado encontrado';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'O modo de linha por aplicativo é compatível apenas com Android';
			...
			case 'settings.importOptions': return 'Importar opções da área de transferência';
			case 'settings.importOptionsMsg': return 'Isso substituirá todas as opções de configuração pelos valores fornecidos. Tem certeza?';
			case 'settings.systemProxyEnabled': return 'Proxy do sistema ativado';
			case 'settings.systemProxyDisabled': return 'Proxy do sistema desativado (reconecte para aplicar)';
			case 'settings.adminPrivilegesRequired': return 'Requer privilégios de administrador no macOS';
			case 'settings.portChangeNotice': return 'Alterações de porta exigem reconexão para serem aplicadas';
			...
			case 'about.appDescription': return 'Um cliente proxy multiplataforma baseado no núcleo sing-box';
			...
			case 'failure.singbox.coreLibraryMissing': return 'Biblioteca do núcleo não instalada';
			case 'failure.singbox.startTimeout': return 'Tempo de inicialização do serviço esgotado';
			...
			case 'failure.connectivity.networkUnavailable': return 'Rede indisponível';
			...
			case 'failure.profiles.noActive': return 'Nenhum perfil ativo';
			...
			case 'play.title': return 'ClashMiao (Pré-visualização)';
			case 'play.short_description': return 'Auto, SSH, VLESS, VMess, Trojan, Reality, Sing-Box, Clash, XRay, Shadowsocks';
			...
			case 'connection.staleSystemProxyCleaned': return 'Configurações de proxy do sistema deixadas por um encerramento anormal foram limpas';
			...
			case 'config.warpDetourModes.proxyOverWarp': return 'Desviar linhas através do WARP';
			case 'config.warpDetourModes.warpOverProxy': return 'Desviar WARP através das linhas';
			...
			case 'config.quickSettingsSubtitle': return 'Personalize sua experiência de conexão';
			case 'config.setupWarp': return 'Configurar WARP';
			case 'config.allOptions': return 'Todas as opções de configuração';
			case 'config.allAdvancedOptions': return 'Todas as opções avançadas';
			case 'config.shortServiceModes.proxy': return 'Somente linha';
			case 'config.shortServiceModes.systemProxy': return 'Linha do sistema';
			case 'config.shortServiceModes.tun': return 'VPN';
			case 'config.shortServiceModes.tunService': return 'Serviço VPN';
			case 'config.blockAds': return 'Bloquear anúncios';
			case 'config.tproxyPort': return 'Porta de linha transparente';
			case 'config.warpNoiseSize': return 'Tamanho do ruído';
			case 'config.warpNoiseMode': return 'Modo de ruído';
			case 'config.desktopProxyScopeNotice': return 'No desktop, apenas aplicativos que respeitam o proxy do sistema passam pelo túnel. Softwares que o ignoram (alguns jogos, ferramentas de linha de comando, apps com configuração de proxy própria) conectam diretamente e expõem seu IP real.';
			default: return null;
		}
	}
}
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.underDevelopment': return 'В разработке';
			case 'general.confirm': return 'Подтвердить';
			case 'intro.termsAndPolicyCaution': return ({required InlineSpanBuilder tap}) => TextSpan(children: [
				const TextSpan(text: 'Продолжая, Вы соглашаетесь с '),
				tap(_root.about.termsAndConditions),
			]);
			...
			case 'home.routingMode.global': return 'Глобальный прокси';
			case 'home.routingMode.smart': return 'Умная маршрутизация';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'Не удалось сменить режим: ${error}';
			case 'home.connectionFailedTitle': return 'Не удалось подключиться';
			case 'home.coreMissingTitle': return 'Библиотека ядра не найдена';
			case 'home.coreMissingMsg': return 'Приложению не удалось загрузить сетевое ядро. Подключение недоступно. Переустановите приложение или убедитесь, что файл библиотеки ядра находится рядом с исполняемым файлом.';
			case 'home.degradedTitle': return 'Подключено, но нет доступа в интернет';
			case 'home.degradedMsg': return 'Туннель поднят, но трафик не проходит. Возможно, узел недоступен — попробуйте другой узел или отключитесь.';
			case 'home.degradedRetry': return 'Проверить ещё раз';
			...
			case 'stats.trafficUsage': return 'Использование трафика';
			case 'stats.liveSpeed': return 'Текущая скорость';
			...
			case 'profile.add.modalSubtitle': return 'Выберите способ добавления файла конфигурации';
			case 'profile.add.manuallyDescription': return 'Введите конфигурацию сервера вручную';
			case 'profile.add.addWarp': return 'Добавить WARP';
			case 'profile.add.warpDescription': return 'Бесплатное ускорение через Cloudflare WARP';
			case 'profile.add.addingWarpMsg': return 'Подождите, идёт регистрация WARP.';
			...
			case 'profile.share.shareLink': return 'Поделиться ссылкой';
			case 'profile.share.subscriptionLinkCopied': return 'Ссылка на подписку скопирована';
			case 'profile.share.configCopied': return 'Конфигурация скопирована';
			case 'profile.share.copyFailed': return 'Не удалось скопировать';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'Добавить';
			case 'profile.actionButtons.updateAll': return 'Обновить все';
			case 'profile.actionButtons.sort': return 'Сортировать';
			case 'profile.actionButtons.copyConfigSuccess': return 'Конфигурация скопирована';
			case 'profile.actionButtons.editConfig': return 'Изменить конфигурацию';
			case 'profile.details.basicInfo': return 'Основные сведения';
			case 'profile.details.subscriptionStatus': return 'Состояние подписки';
			case 'profile.details.options': return 'Параметры';
			case 'profile.details.updateNow': return 'Обновить сейчас';
			case 'profile.details.updateNowDescription': return 'Загрузить актуальную конфигурацию с сервера';
			case 'profile.details.expireDate': return 'Дата окончания';
			case 'profile.details.unlimited': return 'Безлимитно';
			case 'profile.overview.currentlyUsing': return 'Используется сейчас';
			case 'profile.overview.remainingDays': return ({required Object days}) => 'Осталось ${days} дн.';
			case 'profile.remoteProfile': return 'Удалённый профиль';
			...
			case 'proxies.autoSelect': return 'Автовыбор';
			case 'proxies.autoSelectDescription': return 'Автоматически подключаться к самому быстрому узлу';
			case 'proxies.sortModalTitle': return 'Выберите способ сортировки';
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'Проверка задержки: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => 'Переключено на ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => 'Не удалось переключить: ${error}';
			case 'proxies.connectBeforeSwitch': return 'Подключитесь перед сменой линии';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => 'Запущена проверка задержки для ${count} линий';
			case 'proxies.delayTestBtn': return 'Задержка';
			case 'proxies.lineCount': return ({required Object count}) => 'Линий: ${count}';
			case 'proxies.manualSelect': return 'Ручной выбор';
			case 'proxies.autoTest': return 'Автотест';
			...
			case 'logs.logsCleared': return 'Журналы очищены';
			case 'logs.logsCopied': return 'Журналы скопированы';
			case 'logs.logsUnderDevelopment': return 'Функция журналов в разработке';
			case 'logs.noLogsWhenDisconnected': return 'Нет подключения, журналы отсутствуют';
			...
			case 'settings.general.hapticFeedback': return 'Тактильная отдача';
			case 'settings.general.batteryOptimizationStatus.exempted': return 'Исключено';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'Не исключено';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'Профиль VPN сброшен';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'Не удалось загрузить список приложений';
			case 'settings.network.perAppProxyRetry': return 'Повторить';
			case 'settings.network.perAppProxyEmptyMsg': return 'Ничего не найдено';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'Режим линий для отдельных приложений поддерживается только на Android';
			...
			case 'settings.exportAllOptions': return 'Копировать все параметры в буфер обмена';
			case 'settings.systemProxyEnabled': return 'Системный прокси включён';
			case 'settings.systemProxyDisabled': return 'Системный прокси отключён (переподключитесь для применения)';
			case 'settings.adminPrivilegesRequired': return 'На macOS требуются права администратора';
			case 'settings.portChangeNotice': return 'Изменения порта применяются после переподключения';
			...
			case 'about.appDescription': return 'Кроссплатформенный прокси-клиент на основе ядра sing-box';
			...
			case 'failure.singbox.coreLibraryMissing': return 'Библиотека ядра не установлена';
			case 'failure.singbox.startTimeout': return 'Истекло время запуска службы';
			...
			case 'failure.connectivity.networkUnavailable': return 'Сеть недоступна';
			...
			case 'failure.profiles.noActive': return 'Нет активного профиля';
			...
			case 'play.full_description': return 'Основная цель ClashMiao — предоставить безопасный, удобный и эффективный клиент туннелирования. Он позволяет направлять весь трафик или трафик выбранного приложения на указанный Вами удалённый сервер.\nПримечание: мы не предоставляем серверы, пользователи должны сами обеспечивать конфиденциальность своих действий в Интернете, используя собственный сервер или доверенные серверы. Поддерживаются сервера с:— Обычной ссылка на подписку V2ray/Xray— Ссылкой на подписку Clash— Ссылко на подписку на Sing–Box\nВ чём уникальные особенности? — Удобство — Оптимизация и скорость — Автоматический выбор минимальной задержки — Отображение информации об использовании — Простой импорт ссылок одним щелчком мыши — Бесплатно и без рекламы — Простое переключение ссылок — …и много больше\nПоддерживаются:• Все протоколы, поддерживаемые Sing-Box• VLESS + xtls reality, vision• VMESS• Trojan• ShoadowSocks• Reality• V2ray• Hystria2• TUIC• SSH• ShadowTLS\nИсходный код доступен по адресу https://github.com/clashmiao/clashmiao-client.Ядро приложения основано на открытом исходном коде Sing–Box.\nОписание разрешений:— СЛУЖБА VPN: поскольку целью данного приложения является предоставление безопасного, удобного и эффективного клиента туннелирования, это разрешение необходимо, чтобы иметь возможность направлять трафик через туннель на удалённый сервер.— ЗАПРОС ВСЕХ ПАКЕТОВ: это разрешение позволяет добавлять или удалять определённые приложения из списка для туннелирования.— ИНФОРМИРОВАНИЕ О ЗАВЕРШЕНИИ ЗАГРУЗКИ: это разрешение можно включить или отключить в настройках приложения, чтобы (де)активировать запуск приложения при загрузке устройства.— ПОСТОЯННОЕ УВЕДОМЛЕНИЕ: это разрешение необходимо, так как используется приоритетная служба для обеспечения непрерывной работы VPN.— Приложение не содержит рекламы. Сбор аналитики и данных о сбоях происходят только с явного согласия пользователя при первом использовании приложения.';
			...
			case 'connection.staleSystemProxyCleaned': return 'Удалены настройки системного прокси, оставшиеся после аварийного завершения';
			...
			case 'config.warpPort': return 'Port';
			case 'config.warpNoise': return 'Noise';
			case 'config.quickSettingsSubtitle': return 'Настройте подключение под себя';
			case 'config.allAdvancedOptions': return 'Все дополнительные настройки';
			case 'config.blockAds': return 'Блокировать рекламу';
			case 'config.warpNoiseSize': return 'Размер шума';
			case 'config.warpNoiseMode': return 'Режим шума';
			case 'config.warpNoiseDelay': return 'Задержка шума';
			case 'config.desktopProxyScopeNotice': return 'На настольных системах через туннель идут только приложения, соблюдающие системный прокси. Программы, которые его игнорируют (некоторые игры, консольные утилиты, приложения с собственными настройками прокси), подключаются напрямую и раскрывают ваш реальный IP.';
			default: return null;
		}
	}
}
...
extension on TranslationsTr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.clipboardExportSuccessMsg': return 'Panoya kopyalandı';
			case 'general.openAppSettings': return 'Uygulama Ayarlarını Aç';
			case 'general.underDevelopment': return 'Geliştirme Aşamasında';
			case 'general.confirm': return 'Onayla';
			case 'intro.termsAndPolicyCaution': return ({required InlineSpanBuilder tap}) => TextSpan(children: [
				const TextSpan(text: 'devam ederek '),
				tap(_root.about.termsAndConditions),
				const TextSpan(text: ' kabul etmiş olursunuz'),
			...
			case 'home.routingMode.global': return 'Genel Proxy';
			case 'home.routingMode.smart': return 'Akıllı Yönlendirme';
			case 'home.failedToSwitchMode': return ({required Object error}) => 'Mod değiştirilemedi: ${error}';
			case 'home.connectionFailedTitle': return 'Bağlantı Başarısız';
			case 'home.coreMissingTitle': return 'Çekirdek Kitaplığı Bulunamadı';
			case 'home.coreMissingMsg': return 'Uygulama ağ çekirdeğini yükleyemedi. Bağlantı kullanılamıyor. Uygulamayı yeniden kurun ya da çekirdek kitaplık dosyasının çalıştırılabilir dosyanın yanında olduğundan emin olun.';
			case 'home.degradedTitle': return 'Bağlandı, ancak internet erişimi yok';
			case 'home.degradedMsg': return 'Tünel açık ancak trafik geçmiyor. Sunucu çalışmıyor olabilir — başka bir sunucu deneyin veya bağlantıyı kesin.';
			case 'home.degradedRetry': return 'Yeniden Denetle';
			...
			case 'stats.trafficUsage': return 'Trafik Kullanımı';
			case 'stats.liveSpeed': return 'Anlık Hız';
			...
			case 'profile.subscription.upload': return 'Yükleme';
			case 'profile.subscription.download': return 'İndirme';
			...
			case 'profile.add.qrScanner.permissionRequest': return 'QR Kodu taramak için kamera izni';
			...
			case 'profile.add.modalSubtitle': return 'Yapılandırma dosyasını nasıl ekleyeceğinizi seçin';
			case 'profile.add.manuallyDescription': return 'Sunucu yapılandırmasını elle girin';
			case 'profile.add.addWarp': return 'WARP Ekle';
			case 'profile.add.warpDescription': return 'Cloudflare WARP ile ücretsiz hızlandırma';
			case 'profile.add.addingWarpMsg': return 'WARP kaydedilirken lütfen bekleyin.';
			...
			case 'profile.share.shareLink': return 'Bağlantıyı Paylaş';
			case 'profile.share.subscriptionLinkCopied': return 'Abonelik bağlantısı kopyalandı';
			case 'profile.share.configCopied': return 'Yapılandırma kopyalandı';
			case 'profile.share.copyFailed': return 'Kopyalama başarısız';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return 'Ekle';
			case 'profile.actionButtons.updateAll': return 'Tümünü Güncelle';
			case 'profile.actionButtons.sort': return 'Sırala';
			case 'profile.actionButtons.copyConfigSuccess': return 'Yapılandırma kopyalandı';
			case 'profile.actionButtons.editConfig': return 'Yapılandırmayı Düzenle';
			case 'profile.details.basicInfo': return 'Temel Bilgiler';
			case 'profile.details.subscriptionStatus': return 'Abonelik Durumu';
			case 'profile.details.options': return 'Seçenekler';
			case 'profile.details.updateNow': return 'Şimdi Güncelle';
			case 'profile.details.updateNowDescription': return 'Sunucudan en güncel yapılandırmayı al';
			case 'profile.details.expireDate': return 'Son Kullanma Tarihi';
			case 'profile.details.unlimited': return 'Sınırsız';
			case 'profile.overview.currentlyUsing': return 'Şu Anda Kullanılıyor';
			case 'profile.overview.remainingDays': return ({required Object days}) => '${days} gün kaldı';
			case 'profile.remoteProfile': return 'Uzak Profil';
			...
			case 'proxies.checkIp': return 'IP\'yi Denetle';
			case 'proxies.unknownIp': return 'Bilinmeyen IP';
			case 'proxies.autoSelect': return 'Otomatik Seçim';
			case 'proxies.autoSelectDescription': return 'En hızlı sunucuya otomatik bağlan';
			case 'proxies.sortModalTitle': return 'Sıralama yöntemini seçin';
			case 'proxies.activeProxySemanticLabel': return 'Etkin Hat';
			...
			case 'proxies.testingDelayInfo': return ({required Object name}) => 'Gecikme test ediliyor: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => '${name} olarak değiştirildi';
			case 'proxies.switchToFailed': return ({required Object error}) => 'Geçiş başarısız: ${error}';
			case 'proxies.connectBeforeSwitch': return 'Hat değiştirmeden önce bağlanın';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => '${count} hat için gecikme testi başlatıldı';
			case 'proxies.delayTestBtn': return 'Gecikme';
			case 'proxies.lineCount': return ({required Object count}) => '${count} hat';
			case 'proxies.manualSelect': return 'Elle Seçim';
			case 'proxies.autoTest': return 'Otomatik Test';
			case 'logs.pageTitle': return 'Log';
			...
			case 'logs.logsCleared': return 'Günlükler temizlendi';
			case 'logs.logsCopied': return 'Günlükler kopyalandı';
			case 'logs.logsUnderDevelopment': return 'Günlük özelliği geliştirme aşamasında';
			case 'logs.noLogsWhenDisconnected': return 'Bağlı değil, günlük yok';
			...
			case 'settings.general.hapticFeedback': return 'Dokunsal Geri Bildirim';
			case 'settings.general.autoIpCheck': return 'Bağlantı IP’sini Otomatik Denetle';
			case 'settings.general.batteryOptimizationStatus.exempted': return 'Muaf';
			case 'settings.general.batteryOptimizationStatus.notExempted': return 'Muaf Değil';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'VPN profili sıfırlandı';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return 'Uygulama listesi yüklenemedi';
			case 'settings.network.perAppProxyRetry': return 'Yeniden Dene';
			case 'settings.network.perAppProxyEmptyMsg': return 'Sonuç bulunamadı';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return 'Uygulama başına hat modu yalnızca Android’de desteklenir';
			...
			case 'settings.importOptions': return 'Seçenekleri Panodan İçe Aktar';
			case 'settings.importOptionsMsg': return 'Bu işlem tüm yapılandırma seçeneklerini verilen değerlerle değiştirir. Emin misiniz?';
			case 'settings.systemProxyEnabled': return 'Sistem proxy’si etkin';
			case 'settings.systemProxyDisabled': return 'Sistem proxy’si devre dışı (uygulamak için yeniden bağlanın)';
			case 'settings.adminPrivilegesRequired': return 'macOS\'ta yönetici ayrıcalıkları gerekir';
			case 'settings.portChangeNotice': return 'Bağlantı noktası değişikliklerinin uygulanması için yeniden bağlanmak gerekir';
			...
			case 'about.appDescription': return 'sing-box çekirdeğine dayalı çok platformlu proxy istemcisi';
			...
			case 'failure.singbox.coreLibraryMissing': return 'Çekirdek Kitaplığı Yüklü Değil';
			case 'failure.singbox.startTimeout': return 'Servis Başlatma Zaman Aşımı';
			...
			case 'failure.connectivity.networkUnavailable': return 'Ağ Kullanılamıyor';
			...
			case 'failure.profiles.noActive': return 'Etkin Profil Yok';
			...
			case 'play.title': return 'ClashMiao (Önizleme)';
			case 'play.short_description': return 'Otomatik, SSH, VLESS, Vmess, Trojan, Reality, Sing-Box, Clash, Xray, Shadowsocks';
			case 'play.full_description': return 'ClashMiao\'in temel hedefi güvenli, kullanıcı dostu ve verimli bir tünel istemcisi sağlamaktır. VPN Hizmeti iznini kullanarak tüm trafiği veya seçilen uygulama trafiğini seçtiğiniz uzak bir sunucuya yönlendirmenizi sağlar. Not: Herhangi bir sunucu sağlamıyoruz; kullanıcıların kendi barındırılan sunucularını veya güvenilir sunucularını kullanarak çevrimiçi etkinliklerinin gizli kalmasını sağlamaları gerekir. Sunucuları aşağıdakilerle destekliyoruz: - Normal V2ray/Xray Abonelik Bağlantısı - Clash Abonelik Bağlantısı - Sing-Box Abonelik Bağlantısı Benzersiz özelliklerimiz nelerdir? - Kullanıcı Dostu - Optimize Edilmiş ve Hızlı - En Düşük Ping\'i otomatik olarak seçin - Kullanıcı kullanım bilgilerini gösterin - Derin bağlantı kullanarak tek tıklamayla alt bağlantıyı kolayca içe aktarın - Ücretsiz ve ADS Yok - Kullanıcı alt bağlantılarını kolayca değiştirin - giderek daha fazla Destek: - Sing-Box tarafından desteklenen tüm Protokoller - VLESS + xtls gerçeklik, vizyon - VMESS - Trojan - ShoadowSocks - Reality - V2ray - Hystria2 - TUIC - SSH - ShadowTLS Kaynak kodu https://github.com/clashmiao/clashmiao-client adresinde mevcuttur. Uygulama çekirdeği açık tabanlıdır. kaynak şarkı kutusu. İzin Açıklaması: - VPN Hizmeti: Bu uygulamanın amacı güvenli, kullanıcı dostu ve verimli bir tünel istemcisi sağlamak olduğundan, trafiği tünel aracılığıyla uzak sunucuya yönlendirebilmek için bu izne ihtiyacımız var. - TÜM PAKETLERİ SORGULAYIN: Bu izin, kullanıcıların tünelleme için belirli uygulamaları dahil etmesine veya hariç tutmasına izin vermek için kullanılır. - ALMA ÖNYÜKLEME TAMAMLANDI: Bu izin, cihaz önyüklemesi sırasında bu uygulamayı etkinleştirmek için uygulama ayarlarından etkinleştirilebilir veya devre dışı bırakılabilir. - BİLDİRİMLER SONRASI: VPN hizmetinin sürekli çalışmasını sağlamak için bir ön plan hizmeti kullandığımız için bu izin önemlidir. - Bu uygulama reklam içermez. Analitik ve kilitlenme verileri yalnızca uygulamanın ilk kullanımında kullanıcının açık rızası ile gerçekleşir.';
			...
			case 'connection.connectAnyWay': return 'Bağlan';
			case 'connection.reconnectMsg': return 'Değişiklikleri uygulamak için yeniden bağlanılıyor...';
			case 'connection.staleSystemProxyCleaned': return 'Önceki anormal çıkıştan kalan sistem proxy ayarları temizlendi';
			case 'config.resetBtn': return 'Ayarları sıfırla';
			case 'config.serviceMode': return 'Servis modu';
			case 'config.serviceModes.proxy': return 'Proxy';
			case 'config.serviceModes.systemProxy': return 'Sistem Proxy';
			case 'config.serviceModes.tun': return 'VPN';
			case 'config.serviceModes.tunService': return 'VPN Servisi';
			...
			case 'config.warpDetourModes.inbound': return 'Detour WARP through proxies';
			case 'config.warpDetourModes.outbound': return 'Detour proxies through WARP';
			case 'config.warpDetourModes.proxyOverWarp': return 'Hatları WARP Üzerinden Geçir';
			case 'config.warpDetourModes.warpOverProxy': return 'WARP\'ı Hatlar Üzerinden Geçir';
			case 'config.warpLicenseKey': return 'License Key';
			case 'config.warpCleanIp': return 'Clean IP';
			case 'config.warpPort': return 'Port';
			case 'config.warpNoise': return 'Noise';
			case 'config.quickSettings': return 'Hızlı Ayarlar';
			case 'config.quickSettingsSubtitle': return 'Bağlantı deneyiminizi özelleştirin';
			case 'config.setupWarp': return 'WARP Kurulumu';
			case 'config.allOptions': return 'Tüm Yapılandırma Seçenekleri';
			case 'config.allAdvancedOptions': return 'Tüm Gelişmiş Seçenekler';
			case 'config.shortServiceModes.proxy': return 'Yalnızca Hat';
			case 'config.shortServiceModes.systemProxy': return 'Sistem Hattı';
			case 'config.shortServiceModes.tun': return 'VPN';
			case 'config.shortServiceModes.tunService': return 'VPN Servisi';
			...
			case 'config.tproxyPort': return 'Şeffaf Hat Bağlantı Noktası';
			...
			case 'config.desktopProxyScopeNotice': return 'Masaüstünde yalnızca sistem proxy ayarına uyan uygulamalar tünelden geçer. Buna uymayan yazılımlar (bazı oyunlar, komut satırı araçları, kendi proxy ayarı olan uygulamalar) doğrudan bağlanır ve gerçek IP adresinizi açığa çıkarır.';
			default: return null;
		}
	}
}
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'general.appTitle': return 'Clash喵喵';
			...
			case 'general.underDevelopment': return '功能开发中';
			...
			case 'home.emptyProfilesMsg': return '还没有线路喵';
			...
			case 'home.coreMissingTitle': return '未找到核心库';
			case 'home.coreMissingMsg': return '应用没能加载网络核心库，无法建立连接。请重新安装应用，或确认核心库文件与主程序在同一目录下。';
			case 'home.degradedTitle': return '已连接，但无法访问网络';
			case 'home.degradedMsg': return '隧道已建立，但数据送不出去。可能是节点已失效——试试换一个节点，或者断开连接。';
			case 'home.degradedRetry': return '重新检测';
			case 'stats.traffic': return '流量';
			case 'stats.trafficLive': return '实时流量';
			case 'stats.trafficTotal': return '总流量';
			case 'stats.trafficUsage': return '流量使用';
			case 'stats.liveSpeed': return '实时速度';
			...
			case 'profile.actionButtons.add': return '添加';
			case 'profile.actionButtons.updateAll': return '更新全部';
			case 'profile.actionButtons.sort': return '排序';
			case 'profile.actionButtons.copyConfigSuccess': return '配置内容已复制';
			case 'profile.actionButtons.editConfig': return '编辑配置';
			case 'profile.add.buttonText': return '新的配置文件';
			case 'profile.add.shortBtnTxt': return '新的配置文件';
			case 'profile.add.modalSubtitle': return '选择添加配置文件的方式';
			...
			case 'profile.add.manuallyDescription': return '手动输入服务器配置信息';
			case 'profile.add.addWarp': return '添加 WARP';
			case 'profile.add.warpDescription': return '使用 Cloudflare WARP 免费加速';
			...
			case 'profile.details.basicInfo': return '基础信息';
			case 'profile.details.subscriptionStatus': return '订阅状态';
			case 'profile.details.options': return '选项';
			case 'profile.details.updateNow': return '立即更新';
			case 'profile.details.updateNowDescription': return '从服务器获取最新配置';
			case 'profile.details.expireDate': return '到期时间';
			case 'profile.details.unlimited': return '无限期';
			case 'profile.share.buttonText': return '分享';
			case 'profile.share.shareLink': return '分享链接';
			case 'profile.share.subscriptionLinkCopied': return '订阅链接已复制';
			case 'profile.share.configCopied': return '配置内容已复制';
			case 'profile.share.copyFailed': return '复制失败';
			...
			case 'profile.overview.currentlyUsing': return '当前使用';
			case 'profile.overview.remainingDays': return ({required Object days}) => '剩余 ${days} 天';
			...
			case 'profile.detailsForm.userAgent': return 'User-Agent';
			case 'profile.detailsForm.userAgentNotSet': return '未设置';
			case 'profile.detailsForm.mux': return 'Mux 多路复用';
			case 'profile.detailsForm.muxDescription': return '复用出站连接以减少握手开销';
			case 'profile.remoteProfile': return '远程订阅';
			case 'proxies.pageTitle': return '线路';
			case 'proxies.emptyProxiesMsg': return '无可用的线路';
			case 'proxies.delayTestTooltip': return '测试延迟';
			case 'proxies.sortTooltip': return '对线路进行排序';
			case 'proxies.checkIp': return '检测 IP 地址';
			case 'proxies.unknownIp': return '未知的 IP';
			case 'proxies.autoSelect': return '自动选择';
			case 'proxies.autoSelectDescription': return '自动连接到最快的节点';
			...
			case 'proxies.sortModalTitle': return '选择排序方式';
			case 'proxies.activeProxySemanticLabel': return '激活的线路';
			...
			case 'proxies.testingDelayInfo': return ({required Object name}) => '正在测速: ${name}';
			case 'proxies.switchedTo': return ({required Object name}) => '已切换到 ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => '切换失败: ${error}';
			case 'proxies.connectBeforeSwitch': return '请先连接后再切换节点';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => '已开始测试当前订阅的 ${count} 个节点';
			case 'proxies.delayTestBtn': return '测速';
			case 'proxies.lineCount': return ({required Object count}) => '${count} 个节点';
			case 'proxies.manualSelect': return '手动选择';
			case 'proxies.autoTest': return '自动测速';
			...
			case 'logs.logsCleared': return '日志已清空';
			case 'logs.logsCopied': return '日志已复制';
			case 'logs.logsUnderDevelopment': return '日志功能开发中';
			case 'logs.noLogsWhenDisconnected': return '未连接，无日志';
			...
			case 'settings.general.themeModes.system': return '跟随系统颜色';
			...
			case 'settings.general.batteryOptimizationStatus.exempted': return '已豁免';
			case 'settings.general.batteryOptimizationStatus.notExempted': return '未豁免';
			case 'settings.general.batteryOptimizationStatus.pending': return '…';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'VPN 配置文件已重置';
			case 'settings.network.perAppProxyPageTitle': return '分应用线路';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return '加载应用列表失败';
			case 'settings.network.perAppProxyRetry': return '重试';
			case 'settings.network.perAppProxyEmptyMsg': return '未找到匹配的应用';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return '仅 Android 支持分应用线路';
			...
			case 'settings.systemProxyEnabled': return '已开启系统代理';
			case 'settings.systemProxyDisabled': return '已关闭系统代理（需重连生效）';
			case 'settings.adminPrivilegesRequired': return 'macOS 需要管理员权限';
			case 'settings.portChangeNotice': return '端口修改需要重启连接生效';
			...
			case 'about.appDescription': return '基于 sing-box 核心的跨平台代理客户端';
			...
			case 'failure.singbox.coreLibraryMissing': return '核心库未安装';
			...
			case 'failure.singbox.startTimeout': return '服务启动超时';
			...
			case 'failure.connectivity.networkUnavailable': return '网络不可用';
			...
			case 'failure.profiles.noActive': return '没有激活的订阅';
			...
			case 'play.title': return 'ClashMiao（预览）';
			case 'play.short_description': return '自动，SSH, VLESS, Vmess, Trojan, Reality, Sing-Box, Clash, Xray, Shadowsocks';
			case 'play.full_description': return 'ClashMiao 的主要目标是提供安全、用户友好且高效的隧道客户端。它使您能够利用 VPN 服务权限将所有流量或选定的应用程序流量路由到您选择的远程服务器。\n\n注：我们不提供任何服务器；用户需要使用自己托管的服务器或可信的服务器来确保您在线活动的私密性。\n \n我们支持以下类型的服务器：\n- 普通 V2ray/Xray 订阅链接\n- Clash 订阅链接\n- Sing-Box 订阅链接\n\n我们的特色是什么？\n\n- 用户友好\n- 优化和高速\n- 自动选择最低延迟\n- 显示用户使用信息\n- 通过一键链接轻松导入\n- 免费且无广告\n- 轻松切换线路\n- 等等\n\n支持：\n- Sing-Box 支持的所有协议\n- VLESS + XTLS Reality、Vision 协议\n- VMESS\n- Trojan\n- ShadowSocks\n- Reality\n- WireGuard\n- V2ray\n- Hystria2\n- TUIC\n- SSH\n- ShadowTLS\n\n\n源代码位于 https://github.com/clashmiao/clashmiao-client\n应用程序核心基于开源的 Sing-Box。\n\n权限说明：\n\n- VPN 服务：由于此应用程序的目标是提供安全、用户友好和高效的隧道客户端，我们需要此权限以能够通过隧道将流量路由到远程服务器。\n获取应用程序列表：此权限用于允许用户包括或排除特定应用程序以进行隧道传输。\n- 接收开机广播：可以从应用程序设置中启用或禁用此权限，以便在设备启动时激活此应用程序。\n- 发送通知：此权限是必需的，因为我们使用前台服务来确保 VPN 服务的持续运行。\n- 本应用程序没有广告。分析和崩溃数据仅在首次使用应用程序时经用户明确同意的情况下发生。';
			...
			case 'connection.staleSystemProxyCleaned': return '已清理上次异常退出残留的系统代理设置';
			case 'config.resetBtn': return '重置选项';
			case 'config.serviceMode': return '服务模式';
			case 'config.quickSettings': return '快速设置';
			case 'config.quickSettingsSubtitle': return '自定义您的连接体验';
			case 'config.setupWarp': return '配置 WARP';
			case 'config.allOptions': return '全部配置选项';
			case 'config.allAdvancedOptions': return '所有进阶选项';
			case 'config.serviceModes.proxy': return '仅线路';
			case 'config.serviceModes.systemProxy': return '系统线路';
			case 'config.serviceModes.tun': return 'VPN';
			case 'config.serviceModes.tunService': return 'VPN 服务';
			case 'config.shortServiceModes.proxy': return '仅线路';
			case 'config.shortServiceModes.systemProxy': return '系统线路';
			case 'config.shortServiceModes.tun': return 'VPN';
			...
			case 'config.tproxyPort': return '透明线路端口';
			...
			case 'config.setSystemProxy': return '设置系统线路';
			...
			case 'config.warpDetourMode': return '链式线路';
			case 'config.warpDetourModes.proxyOverWarp': return '通过 WARP 连接线路';
			case 'config.warpDetourModes.warpOverProxy': return '通过线路连接 WARP';
			case 'config.warpDetourModes.inbound': return '通过线路绕过 WARP';
			case 'config.warpDetourModes.outbound': return '通过 WARP 绕过线路';
			...
			case 'config.warpNoiseDelay': return '噪音延延迟';
			case 'config.desktopProxyScopeNotice': return '桌面端只有遵循系统代理设置的程序会走隧道。不遵循的软件（部分游戏、命令行工具、自带代理设置的客户端）会直连，暴露你的真实 IP。';
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'general.underDevelopment': return '功能開發中';
			...
			case 'home.routingMode.global': return '全域代理';
			case 'home.routingMode.smart': return '智慧分流';
			case 'home.failedToSwitchMode': return ({required Object error}) => '切換模式失敗：${error}';
			case 'home.connectionFailedTitle': return '連線失敗';
			case 'home.coreMissingTitle': return '找不到核心程式庫';
			case 'home.coreMissingMsg': return '應用程式未能載入網路核心程式庫，無法建立連線。請重新安裝應用程式，或確認核心程式庫檔案與主程式在同一目錄下。';
			case 'home.degradedTitle': return '已連線，但無法存取網路';
			case 'home.degradedMsg': return '通道已建立，但資料送不出去。可能是節點已失效——試試換一個節點，或者中斷連線。';
			case 'home.degradedRetry': return '重新檢測';
			case 'stats.traffic': return '流量';
			...
			case 'stats.trafficUsage': return '流量使用';
			case 'stats.liveSpeed': return '即時速度';
			...
			case 'profile.add.modalSubtitle': return '選擇新增設定檔的方式';
			case 'profile.add.manuallyDescription': return '手動輸入伺服器設定';
			case 'profile.add.warpDescription': return '使用 Cloudflare WARP 免費加速';
			case 'profile.update.buttonTxt': return '更新';
			...
			case 'profile.share.shareLink': return '分享連結';
			case 'profile.share.subscriptionLinkCopied': return '訂閱連結已複製';
			case 'profile.share.configCopied': return '設定已複製';
			case 'profile.share.copyFailed': return '複製失敗';
			...
			case 'profile.detailsForm.mux': return 'Mux';
			case 'profile.detailsForm.muxDescription': return 'Multiplex outbound connections to reduce handshake overhead';
			case 'profile.actionButtons.add': return '新增';
			case 'profile.actionButtons.updateAll': return '全部更新';
			case 'profile.actionButtons.sort': return '排序';
			case 'profile.actionButtons.copyConfigSuccess': return '設定已複製';
			case 'profile.actionButtons.editConfig': return '編輯設定';
			case 'profile.details.basicInfo': return '基本資訊';
			case 'profile.details.subscriptionStatus': return '訂閱狀態';
			case 'profile.details.options': return '選項';
			case 'profile.details.updateNow': return '立即更新';
			case 'profile.details.updateNowDescription': return '從伺服器取得最新設定';
			case 'profile.details.expireDate': return '到期日期';
			case 'profile.details.unlimited': return '無限制';
			case 'profile.overview.currentlyUsing': return '目前使用中';
			case 'profile.overview.remainingDays': return ({required Object days}) => '剩餘 ${days} 天';
			case 'profile.remoteProfile': return '遠端訂閱';
			case 'proxies.pageTitle': return '線路';
			case 'proxies.emptyProxiesMsg': return '沒有可用的線路';
			case 'proxies.delayTestTooltip': return '測試延遲';
			case 'proxies.sortTooltip': return '對線路進行排序';
			...
			case 'proxies.activeProxySemanticLabel': return '生效中的線路';
			...
			case 'proxies.autoSelect': return '自動選擇';
			case 'proxies.autoSelectDescription': return '自動連線到最快的節點';
			case 'proxies.sortModalTitle': return '選擇排序方式';
			case 'proxies.testingDelayInfo': return ({required Object name}) => '正在檢測延遲：${name}';
			case 'proxies.switchedTo': return ({required Object name}) => '已切換到 ${name}';
			case 'proxies.switchToFailed': return ({required Object error}) => '切換失敗：${error}';
			case 'proxies.connectBeforeSwitch': return '請先連線再切換線路';
			case 'proxies.startDelayTestForGroups': return ({required Object count}) => '已開始檢測 ${count} 條線路的延遲';
			case 'proxies.delayTestBtn': return '延遲';
			case 'proxies.lineCount': return ({required Object count}) => '${count} 條線路';
			case 'proxies.manualSelect': return '手動選擇';
			case 'proxies.autoTest': return '自動測速';
			...
			case 'logs.clearTooltip': return '清除';
			case 'logs.logsCleared': return '日誌已清空';
			case 'logs.logsCopied': return '日誌已複製';
			case 'logs.logsUnderDevelopment': return '日誌功能開發中';
			case 'logs.noLogsWhenDisconnected': return '未連線，無日誌';
			...
			case 'settings.general.themeModes.system': return '跟隨系統顏色';
			...
			case 'settings.advanced.resetTunnelSuccess': return 'VPN 設定檔已重設';
			case 'settings.network.perAppProxyPageTitle': return '應用程式線路模式';
			case 'settings.network.perAppProxyModes.off': return '全部';
			case 'settings.network.perAppProxyModes.offMsg': return '透過線路代理所有應用程式';
			case 'settings.network.perAppProxyModes.include': return '代理';
			case 'settings.network.perAppProxyModes.includeMsg': return '僅透過線路代理選定的應用程式';
			case 'settings.network.perAppProxyModes.exclude': return '略過';
			case 'settings.network.perAppProxyModes.excludeMsg': return '不透過線路代理選定的應用程式';
			...
			case 'settings.network.perAppProxyLoadFailedMsg': return '載入應用程式清單失敗';
			case 'settings.network.perAppProxyRetry': return '重試';
			case 'settings.network.perAppProxyEmptyMsg': return '找不到結果';
			case 'settings.network.perAppProxyAndroidOnlyMsg': return '分應用線路模式僅支援 Android';
			...
			case 'settings.systemProxyEnabled': return '系統代理已啟用';
			case 'settings.systemProxyDisabled': return '系統代理已停用（重新連線後生效）';
			case 'settings.adminPrivilegesRequired': return 'macOS 上需要管理員權限';
			case 'settings.portChangeNotice': return '連接埠變更需要重新連線才會生效';
			...
			case 'about.appDescription': return '基於 sing-box 核心的跨平台代理用戶端';
			...
			case 'failure.singbox.coreLibraryMissing': return '核心程式庫未安裝';
			case 'failure.singbox.startTimeout': return '服務啟動逾時';
			...
			case 'failure.connectivity.networkUnavailable': return '網路無法使用';
			...
			case 'failure.profiles.noActive': return '沒有啟用的訂閱';
			...
			case 'play.title': return 'ClashMiao（預覽）';
			case 'play.short_description': return '自動、SSH、VLESS、Vmess、Trojan、Reality、Sing-Box、Clash、Xray、Shadowsocks';
			case 'play.full_description': return 'ClashMiao 的主要目標是提供安全、使用者友好且高效率的隧道用戶端。它使您能夠利用 VPN 服務權限將所有流量或選定的應用程式流量路由到您選擇的遠端伺服器。\n\n註：我們不提供任何伺服器；使用者需要使用自己的自託管伺服器或受信任的伺服器來確保其線上活動的隱私。\n\n我們透過以下方式支援伺服器：\n - 普通 V2ray/Xray 訂閱連結\n - Clash 訂閱連結\n - Sing-Box 訂閱連結\n\n 我們的獨特功能是什麼？\n - 使用者友善\n - 最佳化且快速\n - 自動選擇最低延遲\n - 顯示使用者使用資訊\n - 使用一鍵連結輕鬆導入\n - 免費且無廣告\n - 輕鬆切換線路\n - 等等\n 支援：\n - Sing-Box 支援的所有協定 \n - VLESS + XTLS Reality、Vision 協定 \n - VMESS\n - Trojan\n - ShadowSocks\n - Reality\n - WireGuard\n - V2ray\n - Hystria2\n - TUIC \n - SSH\n - ShadowTLS\n\n\n 原始碼位於 https://github.com/clashmiao/clashmiao-client\n 應用程式核心基於開源的 Sing-Box。\n\n權限說明：\n\n - VPN 服務：由於此應用程式的目標是提供安全性、使用者友好且高效的隧道用戶端，因此我們需要此權限才能透過隧道將流量路由到遠端伺服器。\n - 獲取應用程式列表：此權限用於允許使用者包含或排除隧道的特定應用程式。\n - 接收啟動廣播：可以從應用程式設定中啟用或停用此權限，以在裝置啟動時啟動此應用程式。\n - 傳送通知：此權限至關重要，因為我們使用前台服務來確保 VPN 服務的持續運作。\n - 該應用程式沒有廣告。分析和崩潰數據僅在用戶首次使用應用程式時明確同意的情況下才會出現。';
			...
			case 'connection.staleSystemProxyCleaned': return '已清理上次異常結束殘留的系統代理設定';
			...
			case 'config.serviceModes.proxy': return '僅線路';
			case 'config.serviceModes.systemProxy': return '系統線路';
			case 'config.serviceModes.tun': return 'VPN';
			case 'config.serviceModes.tunService': return 'VPN 服務';
			case 'config.shortServiceModes.proxy': return '僅線路';
			case 'config.shortServiceModes.systemProxy': return '系統線路';
			case 'config.shortServiceModes.tun': return 'VPN';
			...
			case 'config.tproxyPort': return '透明線路埠';
			...
			case 'config.setSystemProxy': return '設定系統線路';
			...
			case 'config.warpDetourMode': return '鏈式線路';
			case 'config.warpDetourModes.proxyOverWarp': return '透過 WARP 連線線路';
			case 'config.warpDetourModes.warpOverProxy': return '透過線路連線 WARP';
			case 'config.warpDetourModes.inbound': return '透過線路繞過 WARP';
			case 'config.warpDetourModes.outbound': return '透過 WARP 繞過線路';
			...
			case 'config.quickSettingsSubtitle': return '自訂您的連線體驗';
			case 'config.allAdvancedOptions': return '所有進階選項';
			case 'config.blockAds': return '封鎖廣告';
			case 'config.warpNoiseSize': return '雜訊大小';
			case 'config.warpNoiseMode': return '雜訊模式';
			case 'config.desktopProxyScopeNotice': return '桌面端只有遵循系統代理設定的程式會走通道。不遵循的軟體（部分遊戲、命令列工具、自帶代理設定的用戶端）會直連，暴露你的真實 IP。';
			default: return null;
		}
	}
}
